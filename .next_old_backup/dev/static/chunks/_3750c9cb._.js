...
function RivalryWidget() {
    ...
    const fetchRivals = async ()=>{
        ...
        if (handle) {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRivals"])(handle);
            setRivals(data);
        }
        setLoading(false);
    };
    ...
    const handleAdd = async (e)=>{
        ...
        const handle = localStorage.getItem('cp-handle');
        if (handle) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addPinnedRival"])(handle, newHandle);
            setNewHandle('');
            fetchRivals();
        }
    };
...
//# sourceMappingURL=_3750c9cb._.js.map