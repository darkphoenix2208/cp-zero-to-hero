...
"[project]/app/data:f95ff8 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:c4a785 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:124fa7 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:4c41f6 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$f95ff8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:f95ff8 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$c4a785__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:c4a785 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$124fa7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:124fa7 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$4c41f6__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:4c41f6 [app-client] (ecmascript) <text/javascript>");
...
function FlashbackPage() {
            ...
            const timer = setTimeout({
                "FlashbackPage.useEffect.timer": async ()=>{
                    if (query.length >= 2 && !selectedProblem) {
                        setSearching(true);
                        try {
                            const hits = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$4c41f6__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["searchProblems"])(query);
    ...
    const refreshCards = ()=>{
        ...
        if (handle) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$f95ff8__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getDueFlashcards"])(handle).then((data)=>{
                setCards(data);
                setLoading(false);
            });
        } else {
    ...
    const handleAdd = async (e)=>{
        ...
        try {
            const handle = localStorage.getItem('cp-handle');
            if (handle) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$124fa7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addToReviewQueue"])(handle, selectedProblem);
    ...
    const handleRate = async (quality)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$c4a785__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["processReview"])({
            id: current.id,
            quality
        });
...
//# sourceMappingURL=_33e6742b._.js.map