...
const GALAXY_SECTORS = [
    // --- SECTOR 1: THE FOUNDATIONS (800-1000) ---
    {
        ...
        prerequisites: [],
        scout_mission: {
            video_url: "https://www.youtube.com/embed/RRVYpIET_RU",
...
m["apple"] = 5;`
    ...
    },
    {
        ...
        prerequisites: [],
        scout_mission: {
            video_url: "https://www.youtube.com/embed/FPu9Uld7W-E",
...
// 1 sec ~= 10^8 ops`
    ...
    },
    {
        ...
        prerequisites: [],
        scout_mission: {
            video_url: "https://www.youtube.com/embed/1xNbjMdbjug",
...
int lcm(int a, int b) {
    ...
    // --- SECTOR 2: THE ALGORITHMIC BELT (1100-1400) ---
    {
        ...
        scout_mission: {
            video_url: "https://www.youtube.com/embed/QNGL_t_o_JA",
...
while (l <= r) {
    ...
    },
    {
        ...
        scout_mission: {
            video_url: "https://www.youtube.com/embed/9kdHxplyl5I",
...
while (r < n) {
    ...
    },
    {
        ...
        scout_mission: {
            video_url: "https://www.youtube.com/embed/PhGuPhgsHam",
...
long long sum = p[R+1] - p[L];`
    ...
    // --- SECTOR 3: THE GRAPH GALAXY (1400-1600) ---
    {
        ...
        scout_mission: {
            video_url: "https://www.youtube.com/embed/pcQI0JkGB_c",
...
while(!pq.empty()){
    ...
    // --- SECTOR 4: THE DYNAMIC DIMENSION (1500-1800) ---
    {
        ...
        scout_mission: {
            video_url: "https://www.youtube.com/embed/TyqY-JzL90k",
...
int solve(int n) {
    ...
    },
    {
        ...
        scout_mission: {
            video_url: "https://www.youtube.com/embed/GqOmJHQZivw",
...
for(int i = 0; i < n; i++) {
    for(int w = W; w >= weight[i]; w--) {
        ...
        colonize_mission: {
            easy_problems: [
                "Knapsack-AtCoder-DP-D",
                "Knapsack-AtCoder-DP-E"
            ],
            medium_problems: [
                "1388C",
                "1042B",
    ...
    // --- SECTOR 5: THE TREE TITANS (1700-1900) ---
    {
        ...
        scout_mission: {
            video_url: "https://www.youtube.com/embed/rwXLiK6Rc7E",
...
const getSectorColor = (sector)=>{
    switch(sector){
        ...
        case 3:
            return "from-yellow-500 to-orange-400"; // Graph Galaxy
        case 4:
            return "from-purple-500 to-pink-400"; // DP Dimension
        case 5:
            return "from-red-500 to-rose-400"; // Tree Titans
        default:
...
function SkillTreeGraph() {
    ...
    // ... loading check ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "h-[65vh] md:h-[800px] w-full border border-zinc-800 rounded-xl bg-zinc-950 overflow-hidden relative shadow-2xl",
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute top-4 left-4 pointer-events-none z-10 hidden md:block",
...
_s(SkillTreeGraph, "MeQJvEWvK4nbFk8tqMDQo/3QrMg=", false, function() {
    return [
...
//# sourceMappingURL=_46e4ee5e._.js.map