...
function FlashbackPage() {
    ...
    const refreshCards = ()=>{
        ...
        if (handle) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$c54d0e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getDueFlashcards"])(handle).then((data)=>{
                setCards(data);
                setLoading(false);
            });
        } else {
...
//# sourceMappingURL=_ce2a186a._.js.map