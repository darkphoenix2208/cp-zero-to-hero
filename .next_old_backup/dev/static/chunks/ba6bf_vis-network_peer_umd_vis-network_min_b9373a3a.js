...
"[project]/node_modules/react-graph-vis/node_modules/vis-network/peer/umd/vis-network.min.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 */ !function(t, e) {
    ("TURBOPACK compile-time truthy", 1) ? e(exports, __turbopack_context__.r("[project]/node_modules/react-graph-vis/node_modules/vis-data/peer/umd/vis-data.js [app-client] (ecmascript)")) : "TURBOPACK unreachable";
}(/*TURBOPACK member replacement*/ __turbopack_context__.e, function(t, e) {
    var i = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable";
    function o(t) {
    ...
    var s = function(t) {
        ...
        return this;
    }() || i || Function("return this")(), r = function(t) {
        try {
            return !!t();
        } catch (t) {
            return !0;
    ...
    }), p = a, g = Function.prototype, f = g.call, m = p && g.bind.bind(f, f), y = p ? m : function(t) {
        return function() {
            return f.apply(t, arguments);
        };
    }, b = y, v = b({}.toString), w = b("".slice), _ = function(t) {
        return w(v(t), 8, -1);
    }, x = _, E = y, O = function(t) {
        if ("Function" === x(t)) return E(t);
    }, C = "object" == typeof document && document.all, k = {
        all: C,
        IS_HTMLDDA: void 0 === C && void 0 !== C
    }, S = k.all, T = k.IS_HTMLDDA ? function(t) {
    ...
    }), I = a, P = Function.prototype.call, B = I ? P.bind(P) : function() {
    ...
    var R, j, L = function(t, e) {
    ...
    }, H = r, W = _, V = Object, q = y("".split), U = H(function() {
        ...
        return Z(Q(t));
    }, J = T, tt = k.all, et = k.IS_HTMLDDA ? function(t) {
        return "object" == typeof t ? null !== t : J(t) || t === tt;
    } : function(t) {
        return "object" == typeof t ? null !== t : J(t);
    }, it = {}, ot = it, st = n, nt = T, rt = function(t) {
        return nt(t) ? t : void 0;
    }, at = function(t, e) {
        return arguments.length < 2 ? rt(ot[t]) || rt(st[t]) : ot[t] && ot[t][e] || st[t] && st[t][e];
    }, ht = y({}.isPrototypeOf), dt = "undefined" != typeof navigator && String(navigator.userAgent) || "", lt = n, ct = dt, ut = lt.process, pt = lt.Deno, gt = ut && ut.versions || pt && pt.version, ft = gt && gt.v8;
    ft && (j = (R = ft.split("."))[0] > 0 && R[0] < 4 ? 1 : +(R[0] + R[1])), !j && ct && (!(R = ct.match(/Edge\/(\d+)/)) || R[1] >= 74) && (R = ct.match(/Chrome\/(\d+)/)) && (j = +R[1]);
    var mt = j, yt = mt, bt = r, vt = n.String, wt = !!Object.getOwnPropertySymbols && !bt(function() {
        var t = Symbol("symbol detection");
        return !vt(t) || !(Object(t) instanceof Symbol) || !Symbol.sham && yt && yt < 41;
    }), _t = wt && !Symbol.sham && "symbol" == typeof Symbol.iterator, xt = at, Et = T, Ot = ht, Ct = Object, kt = _t ? function(t) {
    ...
    }, Mt = T, Dt = Tt, It = TypeError, Pt = function(t) {
        if (Mt(t)) return t;
        throw new It(Dt(t) + " is not a function");
    }, Bt = Pt, Ft = Y, zt = function(t, e) {
        var i = t[e];
        return Ft(i) ? void 0 : Bt(i);
    }, Nt = B, At = T, Rt = et, jt = TypeError, Lt = {
        exports: {}
    }, Ht = n, Wt = Object.defineProperty, Vt = function(t, e) {
        try {
            Wt(Ht, t, {
                value: e,
                configurable: !0,
        ...
        return e;
    }, qt = "__core-js_shared__", Ut = n[qt] || Vt(qt, {}), Yt = Ut;
    ...
    var Xt = Lt.exports, Kt = G, Gt = Object, Zt = function(t) {
        return Gt(Kt(t));
    }, Qt = Zt, $t = y({}.hasOwnProperty), Jt = Object.hasOwn || function(t, e) {
        return $t(Qt(t), e);
    }, te = y, ee = 0, ie = Math.random(), oe = te(1..toString), se = function(t) {
        return "Symbol(" + (void 0 === t ? "" : t) + ")_" + oe(++ee + ie, 36);
    }, ne = Xt, re = Jt, ae = se, he = wt, de = _t, le = n.Symbol, ce = ne("wks"), ue = de ? le.for || le : le && le.withoutSetter || ae, pe = function(t) {
        return re(ce, t) || (ce[t] = he && re(le, t) ? le[t] : ue("Symbol." + t)), ce[t];
    }, ge = B, fe = et, me = kt, ye = zt, be = function(t, e) {
        var i, o;
    ...
    }, ve = TypeError, we = pe("toPrimitive"), _e = function(t, e) {
        ...
        var e = _e(t, "string");
        return xe(e) ? e : e + "";
    }, Oe = et, Ce = n.document, ke = Oe(Ce) && Oe(Ce.createElement), Se = function(t) {
        return ke ? Ce.createElement(t) : {};
    }, Te = Se, Me = !D && !r(function() {
        return 7 !== Object.defineProperty(Te("div"), "a", {
            get: function() {
                return 7;
            }
        }).a;
    }), De = D, Ie = B, Pe = F, Be = L, Fe = $, ze = Ee, Ne = Jt, Ae = Me, Re = Object.getOwnPropertyDescriptor;
    ...
    var je = r, Le = T, He = /#|\.prototype\./, We = function(t, e) {
        var i = qe[Ve(t)];
        return i === Ye || i !== Ue && (Le(e) ? je(e) : !!e);
    }, Ve = We.normalize = function(t) {
        return String(t).replace(He, ".").toLowerCase();
    }, qe = We.data = {}, Ue = We.NATIVE = "N", Ye = We.POLYFILL = "P", Xe = We, Ke = Pt, Ge = a, Ze = O(O.bind), Qe = function(t, e) {
    ...
    }, si = D, ni = Me, ri = Je, ai = oi, hi = Ee, di = TypeError, li = Object.defineProperty, ci = Object.getOwnPropertyDescriptor, ui = "enumerable", pi = "configurable", gi = "writable";
    ...
    var fi = $e, mi = L, yi = D ? function(t, e, i) {
        return fi.f(t, e, mi(1, i));
    } : function(t, e, i) {
        return t[e] = i, t;
    }, bi = n, vi = u, wi = O, _i = T, xi = M.f, Ei = Xe, Oi = it, Ci = Qe, ki = yi, Si = Jt, Ti = function(t) {
        ...
        var i, o, s, n, r, a, h, d, l, c = t.target, u = t.global, p = t.stat, g = t.proto, f = u ? bi : p ? bi[c] : (bi[c] || {}).prototype, m = u ? Oi : Oi[c] || ki(Oi, c, {})[c], y = m.prototype;
    ...
    }, Di = Math.ceil, Ii = Math.floor, Pi = Math.trunc || function(t) {
        var e = +t;
        return (e > 0 ? Ii : Di)(e);
    }, Bi = function(t) {
        var e = +t;
        ...
        return Li(t.length);
    }, Wi = $, Vi = Ai, qi = Hi, Ui = function(t) {
        return function(e, i, o) {
            var s, n = Wi(e), r = qi(n), a = Vi(o, r);
            if (t && i != i) {
        ...
        includes: Ui(!0),
        indexOf: Ui(!1)
    }, Xi = {}, Ki = Jt, Gi = $, Zi = Yi.indexOf, Qi = Xi, $i = y([].push), Ji = function(t, e) {
        var i, o = Gi(t), s = 0, n = [];
    ...
    var no = D, ro = y, ao = B, ho = r, lo = oo, co = so, uo = F, po = Zt, go = U, fo = Object.assign, mo = Object.defineProperty, yo = ro([].concat), bo = !fo || ho(function() {
        if (no && 1 !== fo({
            b: 1
        }, fo(mo({}, "a", {
            enumerable: !0,
    ...
    var wo = o(it.Object.assign), _o = y([].slice), xo = y, Eo = Pt, Oo = et, Co = Jt, ko = _o, So = a, To = Function, Mo = xo([].concat), Do = xo([].join), Io = {}, Po = So ? To.bind : function(t) {
        var e = Eo(this), i = e.prototype, o = ko(arguments, 1), s = function() {
    ...
    function qo(t, e, i, o, s) {
        const n = .5522848, r = o / 2 * n, a = s / 2 * n, h = e + o, d = i + s, l = e + o / 2, c = i + s / 2;
    ...
    function Uo(t, e, i, o, s) {
        const n = s * (1 / 3), r = .5522848, a = o / 2 * r, h = n / 2 * r, d = e + o, l = i + n, c = e + o / 2, u = i + n / 2, p = i + (s - n / 2), g = i + s;
    ...
    function Yo(t, e, i, o, s, n) {
        ...
        const r = n.length, a = o - e, h = s - i, d = h / a;
        let l = Math.sqrt(a * a + h * h), c = 0, u = !0, p = 0, g = +n[0];
    ...
    const Xo = {
        ...
        triangle: function(t, e, i, o) {
            ...
            const s = 2 * o, n = s / 2, r = Math.sqrt(3) / 6 * s, a = Math.sqrt(s * s - n * n);
    ...
    var Go = o(Ko.exports), Zo = _, Qo = Array.isArray || function(t) {
        return "Array" === Zo(t);
    }, $o = TypeError, Jo = function(t) {
        if (t > 9007199254740991) throw $o("Maximum allowed index exceeded");
        return t;
    }, ts = Ee, es = $e, is = L, os = function(t, e, i) {
        var o = ts(e);
        o in t ? es.f(t, o, is(0, i)) : t[o] = i;
    }, ss = {};
    ss[pe("toStringTag")] = "z";
    var ns = "[object z]" === String(ss), rs = ns, as = T, hs = _, ds = pe("toStringTag"), ls = Object, cs = "Arguments" === hs(function() {
        return arguments;
    }()), us = rs ? hs : function(t) {
        var e, i, o;
    ...
    }, ps = T, gs = Ut, fs = y(Function.toString);
    ps(gs.inspectSource) || (gs.inspectSource = function(t) {
        return fs(t);
    });
    var ms = gs.inspectSource, ys = y, bs = r, vs = T, ws = us, _s = ms, xs = function() {}, Es = [], Os = at("Reflect", "construct"), Cs = /^\s*(?:class|function)\b/, ks = ys(Cs.exec), Ss = !Cs.test(xs), Ts = function(t) {
        if (!vs(t)) return !1;
        try {
            return Os(xs, Es, t), !0;
        } catch (t) {
    ...
    }, Ws = Mi, Vs = r, qs = Qo, Us = et, Ys = Zt, Xs = Hi, Ks = Jo, Gs = os, Zs = As, Qs = Hs, $s = mt, Js = pe("isConcatSpreadable"), tn = $s >= 51 || !Vs(function() {
        var t = [];
    ...
    Ws({
        ...
        concat: function(t) {
            var e, i, o, s, n, r = Ys(this), a = Zs(r, 0), h = 0;
            for(e = -1, o = arguments.length; e < o; e++)if (en(n = -1 === e ? r : arguments[e])) for(s = Xs(n), Ks(h + s), i = 0; i < s; i++, h++)i in n && Gs(a, h, n[i]);
            else Ks(h + 1), Gs(a, h++, n);
            return a.length = h, a;
        }
    });
    var on = us, sn = String, nn = function(t) {
        if ("Symbol" === on(t)) throw new TypeError("Cannot convert a Symbol value to a string");
        return sn(t);
    }, rn = {}, an = D, hn = Je, dn = $e, ln = oi, cn = $, un = oo;
    rn.f = an && !hn ? Object.defineProperties : function(t, e) {
        ln(t);
        for(var i, o = cn(e), s = un(e), n = s.length, r = 0; n > r;)dn.f(t, i = s[r++], o[i]);
        return t;
    };
    var pn, gn = at("document", "documentElement"), fn = se, mn = Xt("keys"), yn = function(t) {
        return mn[t] || (mn[t] = fn(t));
    }, bn = oi, vn = rn, wn = to, _n = Xi, xn = gn, En = Se, On = "prototype", Cn = "script", kn = yn("IE_PROTO"), Sn = function() {}, Tn = function(t) {
        return "<" + Cn + ">" + t + "</" + Cn + ">";
    }, Mn = function(t) {
        t.write(Tn("")), t.close();
    ...
    }, Pn = {}, Bn = Ji, Fn = to.concat("length", "prototype");
    Pn.f = Object.getOwnPropertyNames || function(t) {
        return Bn(t, Fn);
    };
    var zn = {}, Nn = Ai, An = Hi, Rn = os, jn = Array, Ln = Math.max, Hn = function(t, e, i) {
        for(var o = An(t), s = Nn(e, o), n = Nn(void 0 === i ? o : i, o), r = jn(Ln(n - s, 0)), a = 0; s < n; s++, a++)Rn(r, a, t[s]);
        return r.length = a, r;
    }, Wn = _, Vn = $, qn = Pn.f, Un = Hn, Yn = "object" == typeof window && window && Object.getOwnPropertyNames ? Object.getOwnPropertyNames(window) : [];
    zn.f = function(t) {
    ...
    var Xn = yi, Kn = function(t, e, i, o) {
        return o && o.enumerable ? t[e] = i : Xn(t, e, i), t;
    }, Gn = $e, Zn = function(t, e, i) {
        return Gn.f(t, e, i);
    }, Qn = {}, $n = pe;
    Qn.f = $n;
    var Jn, tr, er, ir = it, or = Jt, sr = Qn, nr = $e.f, rr = function(t) {
        var e = ir.Symbol || (ir.Symbol = {});
        or(e, t) || nr(e, t, {
            value: sr.f(t)
        });
    }, ar = B, hr = at, dr = pe, lr = Kn, cr = function() {
        var t = hr("Symbol"), e = t && t.prototype, i = e && e.valueOf, o = dr("toPrimitive");
        e && !e[o] && lr(e, o, function(t) {
            return ar(i, this);
        }, {
            arity: 1
        });
    }, ur = us, pr = ns ? ({}).toString : function() {
        return "[object " + ur(this) + "]";
    }, gr = ns, fr = $e.f, mr = yi, yr = Jt, br = pr, vr = pe("toStringTag"), wr = function(t, e, i, o) {
        if (t) {
    ...
    }, _r = T, xr = n.WeakMap, Er = _r(xr) && /native code/.test(String(xr)), Or = Er, Cr = n, kr = et, Sr = yi, Tr = Jt, Mr = Ut, Dr = yn, Ir = Xi, Pr = "Object already initialized", Br = Cr.TypeError, Fr = Cr.WeakMap;
    if (Or || Mr.state) {
    ...
    var Ar = {
    ...
    }, Rr = Qe, jr = U, Lr = Zt, Hr = Hi, Wr = As, Vr = y([].push), qr = function(t) {
        var e = 1 === t, i = 2 === t, o = 3 === t, s = 4 === t, n = 6 === t, r = 7 === t, a = 5 === t || n;
        return function(h, d, l, c) {
            for(var u, p, g = Lr(h), f = jr(g), m = Rr(d, l), y = Hr(f), b = 0, v = c || Wr, w = e ? v(h, y) : i || r ? v(h, 0) : void 0; y > b; b++)if ((a || b in f) && (p = m(u = f[b], b, g), t)) if (e) w[b] = p;
            else if (p) switch(t){
                case 3:
                    return !0;
                case 5:
        ...
        findIndex: qr(6),
        filterReject: qr(7)
    }, Yr = Mi, Xr = n, Kr = B, Gr = y, Zr = D, Qr = wt, $r = r, Jr = Jt, ta = ht, ea = oi, ia = $, oa = Ee, sa = nn, na = L, ra = In, aa = oo, ha = Pn, da = zn, la = so, ca = M, ua = $e, pa = rn, ga = F, fa = Kn, ma = Zn, ya = Xt, ba = Xi, va = se, wa = pe, _a = Qn, xa = rr, Ea = cr, Oa = wr, Ca = Ar, ka = Ur.forEach, Sa = yn("hidden"), Ta = "Symbol", Ma = "prototype", Da = Ca.set, Ia = Ca.getterFor(Ta), Pa = Object[Ma], Ba = Xr.Symbol, Fa = Ba && Ba[Ma], za = Xr.RangeError, Na = Xr.TypeError, Aa = Xr.QObject, Ra = ca.f, ja = ua.f, La = da.f, Ha = ga.f, Wa = Gr([].push), Va = ya("symbols"), qa = ya("op-symbols"), Ua = ya("wks"), Ya = !Aa || !Aa[Ma] || !Aa[Ma].findChild, Xa = function(t, e, i) {
        var o = Ra(Pa, e);
        ...
        ea(t);
        var i = ia(e), o = aa(i).concat(eh(i));
        return ka(o, function(e) {
            Zr && !Kr($a, i, e) || Za(t, e, i[e]);
        }), t;
    }, $a = function(t) {
        var e = oa(t), i = Kr(Ha, this, e);
    ...
    Qr || (Ba = function() {
        ...
        var t = arguments.length && void 0 !== arguments[0] ? sa(arguments[0]) : void 0, e = va(t), i = function(t) {
    ...
    var ih = wt && !!Symbol.for && !!Symbol.keyFor, oh = Mi, sh = at, nh = Jt, rh = nn, ah = Xt, hh = ih, dh = ah("string-to-symbol-registry"), lh = ah("symbol-to-string-registry");
    oh({
        target: "Symbol",
        stat: !0,
        forced: !hh
    ...
    var ch = Mi, uh = Jt, ph = kt, gh = Tt, fh = ih, mh = Xt("symbol-to-string-registry");
    ch({
        target: "Symbol",
        stat: !0,
        forced: !fh
    ...
    var yh = Qo, bh = T, vh = _, wh = nn, _h = y([].push), xh = Mi, Eh = at, Oh = u, Ch = B, kh = y, Sh = r, Th = T, Mh = kt, Dh = _o, Ih = function(t) {
        if (bh(t)) return t;
        if (yh(t)) {
    ...
    }, Ph = wt, Bh = String, Fh = Eh("JSON", "stringify"), zh = kh(/./.exec), Nh = kh("".charAt), Ah = kh("".charCodeAt), Rh = kh("".replace), jh = kh(1..toString), Lh = /[\uD800-\uDFFF]/g, Hh = /^[\uD800-\uDBFF]$/, Wh = /^[\uDC00-\uDFFF]$/, Vh = !Ph || Sh(function() {
    ...
    Fh && xh({
        ...
        stringify: function(t, e, i) {
            var o = Dh(arguments), s = Oh(Vh ? Uh : Fh, null, o);
    ...
    var $h, Jh, td, ed = it.Symbol, id = {}, od = D, sd = Jt, nd = Function.prototype, rd = od && Object.getOwnPropertyDescriptor, ad = sd(nd, "name"), hd = {
        EXISTS: ad,
    ...
    }), ld = Jt, cd = T, ud = Zt, pd = dd, gd = yn("IE_PROTO"), fd = Object, md = fd.prototype, yd = pd ? fd.getPrototypeOf : function(t) {
        var e = ud(t);
        if (ld(e, gd)) return e[gd];
        var i = e.constructor;
        return cd(i) && e instanceof i ? i.prototype : e instanceof fd ? md : null;
    }, bd = r, vd = T, wd = et, _d = In, xd = yd, Ed = Kn, Od = pe("iterator"), Cd = !1;
    ...
    var Sd = {
    ...
    }, Td = Sd.IteratorPrototype, Md = In, Dd = L, Id = wr, Pd = id, Bd = function() {
        return this;
    }, Fd = Mi, zd = B, Nd = hd, Ad = function(t, e, i, o) {
        var s = e + " Iterator";
        return t.prototype = Md(Td, {
            next: Dd(+!o, i)
        }), Id(t, s, !1, !0), Pd[s] = Bd, t;
    }, Rd = yd, jd = wr, Ld = Kn, Hd = id, Wd = Sd, Vd = Nd.PROPER, qd = Wd.BUGGY_SAFARI_ITERATORS, Ud = pe("iterator"), Yd = "keys", Xd = "values", Kd = "entries", Gd = function() {
        return this;
        ...
        }, c = e + " Iterator", u = !1, p = t.prototype, g = p[Ud] || p["@@iterator"] || s && p[s], f = !qd && g || l(s), m = "Array" === e && p.entries || g;
        if (m && (a = Rd(m.call(new t))) !== Object.prototype && a.next && (jd(a, c, !0, !0), Hd[c] = Gd), Vd && s === Xd && g && g.name !== Xd && (u = !0, f = function() {
            ...
            keys: n ? f : l(Yd),
            entries: l(Kd)
        }, r) for(d in h)(qd || u || !(d in p)) && Ld(p, d, h[d]);
        else Fd({
            target: e,
            proto: !0,
            forced: qd || u
    ...
    $e.f;
    var el = Zd, il = Qd, ol = "Array Iterator", sl = tl.set, nl = tl.getterFor(ol);
    el(Array, "Array", function(t, e) {
        ...
        var t = nl(this), e = t.target, i = t.kind, o = t.index++;
    ...
    var rl = {
        ...
        TextTrackList: 0,
        TouchList: 0
    }, al = n, hl = us, dl = yi, ll = id, cl = pe("toStringTag");
    for(var ul in rl){
        var pl = al[ul], gl = pl && pl.prototype;
        gl && hl(gl) !== cl && dl(gl, cl, ul), ll[ul] = ll.Array;
    }
    var fl = ed, ml = o(fl), yl = Mi, bl = Qo, vl = Ds, wl = et, _l = Ai, xl = Hi, El = $, Ol = os, Cl = pe, kl = _o, Sl = Hs("slice"), Tl = Cl("species"), Ml = Array, Dl = Math.max;
    yl({
        target: "Array",
        proto: !0,
        forced: !Sl
        ...
        slice: function(t, e) {
            var i, o, s, n = El(this), r = xl(n), a = _l(t, r), h = _l(void 0 === e ? r : e, r);
    ...
    var Il = zo("Array").slice, Pl = ht, Bl = Il, Fl = Array.prototype, zl = function(t) {
        var e = t.slice;
        return t === Fl || Pl(Fl, t) && e === Fl.slice ? Bl : e;
    }, Nl = o(zl), Al = at, Rl = Pn, jl = so, Ll = oi, Hl = y([].concat), Wl = Al("Reflect", "ownKeys") || function(t) {
        var e = Rl.f(Ll(t)), i = jl.f;
        return i ? Hl(e, i(t)) : e;
    };
    Mi({
        target: "Array",
    ...
    var Vl = o(it.Array.isArray), ql = Ur.map;
    Mi({
        target: "Array",
        proto: !0,
        forced: !Hs("map")
    ...
    var Ul = zo("Array").map, Yl = ht, Xl = Ul, Kl = Array.prototype, Gl = function(t) {
        var e = t.map;
    ...
    var Jl = o(it.Object.keys), tc = Mi, ec = Date, ic = y(ec.prototype.getTime);
    tc({
        target: "Date",
        stat: !0
    }, {
    ...
    var oc = o(it.Date.now), sc = r, nc = function(t, e) {
        var i = [][t];
    ...
    }, rc = Ur.forEach, ac = nc("forEach") ? [].forEach : function(t) {
    ...
    var hc = zo("Array").forEach, dc = us, lc = Jt, cc = ht, uc = hc, pc = Array.prototype, gc = {
        DOMTokenList: !0,
        NodeList: !0
    }, fc = function(t) {
        var e = t.forEach;
        return t === pc || cc(pc, t) && e === pc.forEach || lc(gc, dc(t)) ? uc : e;
    }, mc = o(fc), yc = Mi, bc = Qo, vc = y([].reverse), wc = [
        1,
        2
    ];
    yc({
    ...
    var _c = zo("Array").reverse, xc = ht, Ec = _c, Oc = Array.prototype, Cc = function(t) {
        var e = t.reverse;
        return t === Oc || xc(Oc, t) && e === Oc.reverse ? Ec : e;
    }, kc = o(Cc), Sc = D, Tc = Qo, Mc = TypeError, Dc = Object.getOwnPropertyDescriptor, Ic = Sc && !function() {
    ...
    }(), Pc = Tt, Bc = TypeError, Fc = function(t, e) {
        if (!delete t[e]) throw new Bc("Cannot delete property " + Pc(e) + " of " + Pc(t));
    }, zc = Mi, Nc = Zt, Ac = Ai, Rc = Bi, jc = Hi, Lc = Ic ? function(t, e) {
        if (Tc(t) && !Dc(t, "length").writable) throw new Mc("Cannot set read only .length");
        return t.length = e;
    } : function(t, e) {
        return t.length = e;
    }, Hc = Jo, Wc = As, Vc = os, qc = Fc, Uc = Hs("splice"), Yc = Math.max, Xc = Math.min;
    zc({
        target: "Array",
        proto: !0,
        forced: !Uc
        ...
        splice: function(t, e) {
            var i, o, s, n, r, a, h = Nc(this), d = jc(h), l = Ac(t, d), c = arguments.length;
    ...
    var Kc = zo("Array").splice, Gc = ht, Zc = Kc, Qc = Array.prototype, $c = function(t) {
        var e = t.splice;
        return t === Qc || Gc(Qc, t) && e === Qc.splice ? Zc : e;
    }, Jc = o($c), tu = Yi.includes;
    Mi({
        target: "Array",
        proto: !0,
        forced: r(function() {
    ...
    var eu = zo("Array").includes, iu = et, ou = _, su = pe("match"), nu = function(t) {
        var e;
        return iu(t) && (void 0 !== (e = t[su]) ? !!e : "RegExp" === ou(t));
    }, ru = TypeError, au = pe("match"), hu = Mi, du = function(t) {
        if (nu(t)) throw new ru("The method doesn't accept regular expressions");
        return t;
    }, lu = G, cu = nn, uu = function(t) {
        var e = /./;
        try {
            "/./"[t](e);
        } catch (i) {
    ...
    var gu = zo("String").includes, fu = ht, mu = eu, yu = gu, bu = Array.prototype, vu = String.prototype, wu = function(t) {
        var e = t.includes;
        return t === bu || fu(bu, t) && e === bu.includes ? mu : "string" == typeof t || t === vu || fu(vu, t) && e === vu.includes ? yu : e;
    }, _u = o(wu), xu = Zt, Eu = yd, Ou = dd;
    Mi({
        target: "Object",
        stat: !0,
        forced: r(function() {
    ...
    var Cu = o(it.Object.getPrototypeOf), ku = zo("Array").concat, Su = ht, Tu = ku, Mu = Array.prototype, Du = function(t) {
        var e = t.concat;
        return t === Mu || Su(Mu, t) && e === Mu.concat ? Tu : e;
    }, Iu = o(Du), Pu = Ur.filter;
    Mi({
        target: "Array",
        proto: !0,
        forced: !Hs("filter")
    ...
    var Bu = zo("Array").filter, Fu = ht, zu = Bu, Nu = Array.prototype, Au = function(t) {
        var e = t.filter;
        return t === Nu || Fu(Nu, t) && e === Nu.filter ? zu : e;
    }, Ru = o(Au), ju = D, Lu = r, Hu = y, Wu = yd, Vu = oo, qu = $, Uu = Hu(F.f), Yu = Hu([].push), Xu = ju && Lu(function() {
        var t = Object.create(null);
        return t[2] = 2, !Uu(t, 2);
    }), Ku = function(t) {
        return function(e) {
            for(var i, o = qu(e), s = Vu(o), n = Xu && null === Wu(o), r = s.length, a = 0, h = []; r > a;)i = s[a++], ju && !(n ? i in o : Uu(o, i)) || Yu(h, t ? [
                i,
                o[i]
            ] : o[i]);
            return h;
    ...
    var Zu = o(it.Object.values), Qu = "\t\n\v\f\r                　\u2028\u2029\ufeff", $u = G, Ju = nn, tp = Qu, ep = y("".replace), ip = RegExp("^[" + tp + "]+"), op = RegExp("(^|[^" + tp + "])[" + tp + "]+$"), sp = function(t) {
        return function(e) {
            var i = Ju($u(e));
        ...
        trim: sp(3)
    }, rp = n, ap = r, hp = y, dp = nn, lp = np.trim, cp = Qu, up = rp.parseInt, pp = rp.Symbol, gp = pp && pp.iterator, fp = /^[+-]?0x/i, mp = hp(fp.exec), yp = 8 !== up(cp + "08") || 22 !== up(cp + "0x16") || gp && !ap(function() {
        up(Object(gp));
    }) ? function(t, e) {
        var i = lp(dp(t));
    ...
    var bp = o(it.parseInt), vp = Mi, wp = Yi.indexOf, _p = nc, xp = O([].indexOf), Ep = !!xp && 1 / xp([
        1
    ], 1, -0) < 0;
    vp({
        target: "Array",
    ...
    var Op = zo("Array").indexOf, Cp = ht, kp = Op, Sp = Array.prototype, Tp = function(t) {
        var e = t.indexOf;
    ...
    var Dp = it.Object, Ip = o(function(t, e) {
    ...
    }, zp = o(Fp), Np = "function" == typeof Bun && Bun && "string" == typeof Bun.version, Ap = TypeError, Rp = n, jp = u, Lp = T, Hp = Np, Wp = dt, Vp = _o, qp = function(t, e) {
        if (t < e) throw new Ap("Not enough arguments");
        return t;
    }, Up = Rp.Function, Yp = /MSIE .\./.test(Wp) || Hp && function() {
        var t = Rp.Bun.version.split(".");
        return t.length < 3 || "0" === t[0] && (t[1] < 3 || "3" === t[1] && "0" === t[2]);
    }(), Xp = function(t, e) {
        var i = e ? 2 : 1;
        return Yp ? function(o, s) {
            var n = qp(arguments.length, 1) > i, r = Lp(o) ? o : Up(o), a = n ? Vp(arguments, i) : [], h = n ? function() {
                jp(r, this, a);
            } : r;
            return e ? t(h, s) : t(h);
        } : t;
    }, Kp = Mi, Gp = n, Zp = Xp(Gp.setInterval, !0);
    Kp({
        global: !0,
        bind: !0,
    ...
    var Qp = Mi, $p = n, Jp = Xp($p.setTimeout, !0);
    Qp({
        global: !0,
        bind: !0,
    ...
    var tg = o(it.setTimeout), eg = Zt, ig = Ai, og = Hi, sg = function(t) {
    ...
    var ng, rg = zo("Array").fill, ag = ht, hg = rg, dg = Array.prototype, lg = function(t) {
        var e = t.fill;
	 ...
	 * Licensed under the MIT license */ function ug() {
    ...
    var fg, mg = ng, yg = [
        ...
        style: {}
    } : document.createElement("div"), vg = Math.round, wg = Math.abs, _g = Date.now;
    function xg(t, e) {
    ...
    var Eg = xg(bg.style, "touchAction"), Og = void 0 !== Eg;
    var Cg = "compute", kg = "auto", Sg = "manipulation", Tg = "none", Mg = "pan-x", Dg = "pan-y", Ig = function() {
        if (!Og) return !1;
        var t = {}, e = fg.CSS && fg.CSS.supports;
        return [
            "auto",
            "manipulation",
            "pan-y",
    ...
    }(), Pg = "ontouchstart" in fg, Bg = void 0 !== xg(fg, "PointerEvent"), Fg = Pg && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent), zg = "touch", Ng = "mouse", Ag = 25, Rg = 1, jg = 4, Lg = 8, Hg = 1, Wg = 2, Vg = 4, qg = 8, Ug = 16, Yg = Wg | Vg, Xg = qg | Ug, Kg = Yg | Xg, Gg = [
        "x",
        "y"
    ], Zg = [
        "clientX",
    ...
    var tf = function() {
        ...
        return e.set = function(t) {
            ...
            if (this.manager.session.prevented) e.preventDefault();
                ...
                var o = this.actions, s = Jg(o, Tg) && !Ig[Tg], n = Jg(o, Dg) && !Ig[Dg], r = Jg(o, Mg) && !Ig[Mg];
                if (s) {
    ...
    function nf(t, e, i) {
        i || (i = Gg);
        var o = e[i[0]] - t[i[0]], s = e[i[1]] - t[i[1]];
    ...
    function df(t, e) {
        ...
        var d, l, c = hf(e.deltaTime, e.deltaX, e.deltaY);
        e.overallVelocityX = c.x, e.overallVelocityY = c.y, e.overallVelocity = wg(c.x) > wg(c.y) ? c.x : c.y, e.scale = r ? (d = r.pointers, nf((l = o)[0], l[1], Zg) / nf(d[0], d[1], Zg)) : 1, e.rotation = r ? function(t, e) {
            ...
            var i, o, s, n, r = t.lastInterval || e, a = e.timeStamp - r.timeStamp;
            if (e.eventType !== Lg && (a > Ag || void 0 === r.velocity)) {
                var h = e.deltaX - r.deltaX, d = e.deltaY - r.deltaY, l = hf(a, h, d);
        ...
        var u, p = t.element, g = e.srcEvent;
        ef(u = g.composedPath ? g.composedPath()[0] : g.path ? g.path[0] : g.target, p) && (p = u), e.target = p;
    }
    function lf(t, e, i) {
        var o = i.pointers.length, s = i.changedPointers.length, n = e & Rg && o - s == 0, r = e & (jg | Lg) && o - s == 0;
    ...
    var yf = {
        ...
        4: Ng,
        5: "kinect"
    }, vf = "pointerdown", wf = "pointermove pointerup pointercancel";
    ...
    var _f = function(t) {
        ...
        return pg(e, t), e.prototype.handler = function(t) {
            var e = this.store, i = !1, o = t.type.toLowerCase().replace("ms", ""), s = yf[o], n = bf[t.pointerType] || t.pointerType, r = n === zg, a = mf(e, t.pointerId, "pointerId");
    ...
    var Of = {
        ...
        return pg(e, t), e.prototype.handler = function(t) {
            var e = Of[t.type], i = kf.call(this, t, e);
    ...
    function kf(t, e) {
        var i, o, s = xf(t.touches), n = this.targetIds;
        if (e & (2 | Rg) && 1 === s.length) return n[s[0].identifier] = !0, [
            s,
            s
        ];
        var r = xf(t.changedTouches), a = [], h = this.target;
    ...
    function Pf(t) {
        for(var e = t.srcEvent.clientX, i = t.srcEvent.clientY, o = 0; o < this.lastTouches.length; o++){
            var s = this.lastTouches[o], n = Math.abs(e - s.x), r = Math.abs(i - s.y);
        ...
        return function(t) {
            function e(e, i) {
                ...
                return (o = t.call(this, e, i) || this).handler = function(t, e, i) {
                    var s = i.pointerType === zg, n = i.pointerType === Ng;
                    if (!(n && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
                        if (s) If.call(gg(gg(o)), e, i);
                        else if (n && Pf.call(gg(gg(o)), i)) return;
                        o.callback(t, e, i);
                    }
    ...
    var jf = function() {
        ...
        return e.set = function(t) {
            ...
            var e = mg({}, t);
            if (!$g(this.options.enable, [
                this,
                e
            ])) return this.reset(), void (this.state = zf);
        ...
        return i.getTouchAction = function() {
            ...
            var e = this, i = this.options, o = t.pointers.length === i.pointers, s = t.distance < i.threshold, n = t.deltaTime < i.time;
            if (this.reset(), t.eventType & Rg && 0 === this.count) return this.failTimeout();
            if (s && n && o) {
                if (t.eventType !== jg) return this.failTimeout();
                var r = !this.pTime || t.timeStamp - this.pTime < i.interval, a = !this.pCenter || nf(this.pCenter, t.center) < i.posThreshold;
        ...
        return i.attrTest = function(t) {
            ...
            var e = this.state, i = t.eventType, o = 6 & e, s = this.attrTest(t);
    ...
    var Vf = function(t) {
        ...
        return i.getTouchAction = function() {
            ...
            var e = this.options, i = !0, o = t.distance, s = t.direction, n = t.deltaX, r = t.deltaY;
        ...
        return i.getTouchAction = function() {
            ...
            var e = this, i = this.options, o = t.pointers.length === i.pointers, s = t.distance < i.threshold, n = t.deltaTime > i.time;
            if (this._input = t, !s || !o || t.eventType & (jg | Lg) && !n) this.reset();
            else if (t.eventType & Rg) this.reset(), this._timer = setTimeout(function() {
                e.state = 8, e.tryEmit();
            }, i.time);
    ...
    var Qf = function() {
        ...
        return e.set = function(t) {
            ...
            if (!e.stopped) {
                ...
                var o = this.recognizers, s = e.curRecognizer;
            ...
            var e = this.get(t);
            if (t) {
                var i = this.recognizers, o = mf(i, e);
    ...
    function tm(t, e) {
        var i = xf(t.touches), o = xf(t.changedTouches);
        return e & (jg | Lg) && (i = Ef(i.concat(o), "identifier", !0)), [
            i,
            o
        ];
    }
    ...
    var im = em(function(t, e, i) {
        ...
        return t;
    }, "extend", "Use `assign`."), om = em(function(t, e) {
        return im(t, e, !0);
    }, "merge", "Use `assign`.");
    function sm(t, e, i) {
        var o, s = e.prototype;
    ...
    const cm = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i, um = /^#?([a-f\d])([a-f\d])([a-f\d])$/i, pm = /^rgb\( *(1?\d{1,2}|2[0-4]\d|25[0-5]) *, *(1?\d{1,2}|2[0-4]\d|25[0-5]) *, *(1?\d{1,2}|2[0-4]\d|25[0-5]) *\)$/i, gm = /^rgba\( *(1?\d{1,2}|2[0-4]\d|25[0-5]) *, *(1?\d{1,2}|2[0-4]\d|25[0-5]) *, *(1?\d{1,2}|2[0-4]\d|25[0-5]) *, *([01]|0?\.\d+) *\)$/i;
    function fm(t) {
    ...
    function vm(t, e) {
        ...
        for(const o in t)if (void 0 !== e[o]) if (null === e[o] || "object" != typeof e[o]) bm(t, e, o, i);
        else {
            const s = t[o], n = e[o];
            ym(s) && ym(n) && vm(s, n, i);
        }
    ...
    function wm(t, e, i) {
        ...
        for(let s = 0; s < t.length; s++){
            const n = t[s];
            if (Object.prototype.hasOwnProperty.call(i, n)) if (i[n] && i[n].constructor === Object) void 0 === e[n] && (e[n] = {}), e[n].constructor === Object ? xm(e[n], i[n], !1, o) : bm(e, i, n, o);
            else {
    ...
    function _m(t, e, i) {
        let o = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
        if (Vl(i)) throw new TypeError("Arrays are not supported by deepExtend");
        for(const s in i)if (Object.prototype.hasOwnProperty.call(i, s) && !_u(t).call(t, s)) if (i[s] && i[s].constructor === Object) void 0 === e[s] && (e[s] = {}), e[s].constructor === Object ? xm(e[s], i[s]) : bm(e, i, s, o);
        else if (Vl(i[s])) {
            e[s] = [];
    ...
    function xm(t, e) {
        let i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], o = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
        for(const n in e)if (Object.prototype.hasOwnProperty.call(e, n) || !0 === i) if ("object" == typeof e[n] && null !== e[n] && Cu(e[n]) === Object.prototype) void 0 === t[n] ? t[n] = xm({}, e[n], i) : "object" == typeof t[n] && null !== t[n] && Cu(t[n]) === Object.prototype ? xm(t[n], e[n], i) : bm(t, e, n, o);
        else if (Vl(e[n])) {
            var s;
            t[n] = Nl(s = e[n]).call(s);
        } else bm(t, e, n, o);
        ...
        if (mm(t)) {
            ...
            if (!0 === Bm(e)) {
                const t = function(t) {
                    ...
                    v: .8 * t.v
                }, s = Pm(o.h, o.s, o.v), n = Pm(i.h, i.s, i.v);
                return {
                    background: e,
                    border: s,
                    highlight: {
    ...
    function Dm(t, e, i) {
        t /= 255, e /= 255, i /= 255;
        const o = Math.min(t, Math.min(e, i)), s = Math.max(t, Math.max(e, i));
        if (o === s) return {
            h: 0,
            s: 0,
            v: o
    ...
    function Im(t, e, i) {
        let o, s, n;
        const r = Math.floor(6 * t), a = 6 * t - r, h = i * (1 - e), d = i * (1 - a * e), l = i * (1 - (1 - a) * e);
        switch(r % 6){
            case 0:
                o = i, s = l, n = h;
                break;
    ...
    let Lm = class {
        ...
        _setColor(t) {
            ...
            const e = Dm(t.r, t.g, t.b), i = 2 * Math.PI, o = this.r * e.s, s = this.centerCoordinates.x + o * Math.sin(i * e.h), n = this.centerCoordinates.y + o * Math.cos(i * e.h);
        ...
        _updatePicker() {
            ...
            const e = Dm(t.r, t.g, t.b), i = this.colorPickerCanvas.getContext("2d");
            ...
            const o = this.colorPickerCanvas.clientWidth, s = this.colorPickerCanvas.clientHeight;
        ...
        _generateHueCircle() {
            if (!1 === this.generated) {
                ...
                const e = this.colorPickerCanvas.clientWidth, i = this.colorPickerCanvas.clientHeight;
                let o, s, n, r;
                t.clearRect(0, 0, e, i), this.centerCoordinates = {
                    x: .5 * e,
                    y: .5 * i
                }, this.r = .49 * e;
                const a = 2 * Math.PI / 360, h = 1 / 360, d = 1 / this.r;
                let l;
        ...
        _moveSelector(t) {
            const e = this.colorPickerDiv.getBoundingClientRect(), i = t.center.x - e.left, o = t.center.y - e.top, s = .5 * this.colorPickerDiv.clientHeight, n = .5 * this.colorPickerDiv.clientWidth, r = i - n, a = o - s, h = Math.atan2(r, a), d = .98 * Math.min(Math.sqrt(r * r + a * a), n), l = Math.cos(h) * d + s, c = Math.sin(h) * d + n;
            ...
            let u = h / (2 * Math.PI);
            u = u < 0 ? u + 1 : u;
            const p = d / this.r, g = Dm(this.color.r, this.color.g, this.color.b);
            g.h = u, g.s = p;
    ...
    const Um = lm, Ym = class {
        constructor(t, e, i){
            let o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 1, s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : ()=>!1;
        ...
        setOptions(t) {
            if (void 0 !== t) {
                ...
                else if (Vl(t)) this.options.filter = t.join();
        ...
        _create() {
            ...
            let e = 0, i = !1;
            for(const o in this.configureOptions)Object.prototype.hasOwnProperty.call(this.configureOptions, o) && (this.allowCreation = !1, i = !1, "function" == typeof t ? (i = t(o, []), i = i || this._handleObject(this.configureOptions[o], [
                o
            ], !0)) : !0 !== t && -1 === Mp(t).call(t, o) || (i = !0), !1 !== i && (this.allowCreation = !0, e > 0 && this._makeItem([]), this._makeHeader(o), this._handleObject(this.configureOptions[o], [
                o
            ])), e++);
        ...
        _makeRange(t, e, i) {
            const o = t[0], s = t[1], n = t[2], r = t[3], a = document.createElement("input");
            ...
            const u = this._makeLabel(i[i.length - 1], i), p = this._makeItem(i, u, a, l);
        ...
        _makeColorField(t, e, i) {
            const o = t[1], s = document.createElement("div");
        ...
        _handleObject(t) {
            let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], o = !1;
            const s = Ru(this.options);
            let n = !1;
            for(const r in t)if (Object.prototype.hasOwnProperty.call(t, r)) {
                o = !0;
                const a = t[r], h = Em(e, r);
                if ("function" == typeof s && (o = s(r, e), !1 === o && !Vl(a) && "string" != typeof a && "boolean" != typeof a && a instanceof Object && (this.allowCreation = !1, o = this._handleObject(a, h, !0), this.allowCreation = !1 === i)), !1 !== o) {
                    ...
                    if (Vl(a)) this._handleArray(a, t, h);
                        ...
                        if (!this.hideOption(e, r, this.moduleOptions)) if (void 0 !== a.enabled) {
                            const t = Em(h, "enabled"), e = this._getValue(t);
                            if (!0 === e) {
        ...
        _constructOptions(t, e) {
            let i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, o = i;
        ...
        show(t) {
            if (void 0 === t && (t = !0), !0 === t) {
                const t = this.frame.clientHeight, e = this.frame.clientWidth, i = this.frame.parentNode.clientHeight, o = this.frame.parentNode.clientWidth;
                let s = 0, n = 0;
        ...
        static getSuggestion(e, i, o) {
            const s = t.findInOptions(e, i, o, !1), n = t.findInOptions(e, Wm, [], !0);
            let r;
        ...
        static findInOptions(e, i, o) {
            let s = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], n = 1e9, r = "", a = [];
    ...
    function Qm(t) {
        return iy = t, function() {
            var t = {};
            oy = 0, (sy = iy.charAt(0)), fy(), "strict" === ny && (t.strict = !0, fy());
    ...
    function uy(t, e) {
        for(var i, o, s = null, n = [
            t
        ], r = t; r.parent;)n.push(r.parent), r = r.parent;
        if (r.nodes) {
            for(i = 0, o = r.nodes.length; i < o; i++)if (e.id === r.nodes[i].id) {
                s = r.nodes[i];
                break;
            }
        }
    ...
    function wy() {
        ...
        if (_u(r).call(r, "dir")) {
            ...
            for(t = 0; t < n.length; t++)if ("arrows" === n[t].name) if (null != n[t].value.to) d.arrows.to = t;
            else {
                if (null == n[t].value.from) throw _y("Invalid value of arrows");
                d.arrows.from = t;
            }
            else "dir" === n[t].name && (d.dir = t);
            var l, c, u = n[d.dir].value;
    ...
    function Cy(t) {
        ...
        if (i.edges) {
            ...
            mc(s = i.edges).call(s, function(t) {
                ...
                (a = i, h = function(e, i) {
                    var s = gy(o, e.id, i.id, t.type, t.attr), r = n(s);
                    o.edges.push(r);
    ...
    function Sy(t, e) {
        ...
        const s = t.edges, n = Zl(s).call(s, (t)=>{
            const e = {
                from: t.source,
                id: t.id,
                to: t.target
    ...
    class Dy {
        ...
        init() {
            ...
            const t = this.image.width, e = this.image.height;
            this.width = t, this.height = e;
            const i = Math.floor(e / 2), o = Math.floor(e / 4), s = Math.floor(e / 8), n = Math.floor(e / 16), r = Math.floor(t / 2), a = Math.floor(t / 4), h = Math.floor(t / 8), d = Math.floor(t / 16);
        ...
        _fillMipMap() {
            const t = this.canvas.getContext("2d"), e = this.coordinates[0];
            t.drawImage(this.image, e[0], e[1], e[2], e[3]);
            for(let e = 1; e < this.NUM_ITERATIONS; e++){
                const i = this.coordinates[e - 1], o = this.coordinates[e];
    ...
    }), Fy = r, zy = et, Ny = _, Ay = By, Ry = Object.isExtensible, jy = Fy(function() {
        Ry(1);
    }) || Ay ? function(t) {
        return !!zy(t) && (!Ay || "ArrayBuffer" !== Ny(t)) && (!Ry || Ry(t));
    } : Ry, Ly = !r(function() {
        return Object.isExtensible(Object.preventExtensions({}));
    }), Hy = Mi, Wy = y, Vy = Xi, qy = et, Uy = Jt, Yy = $e.f, Xy = Pn, Ky = zn, Gy = jy, Zy = Ly, Qy = !1, $y = se("meta"), Jy = 0, tb = function(t) {
        Yy(t, $y, {
            value: {
                objectID: "O" + Jy++,
                weakData: {}
    ...
    Vy[$y] = !0;
    var ib = Py.exports, ob = id, sb = pe("iterator"), nb = Array.prototype, rb = us, ab = zt, hb = Y, db = id, lb = pe("iterator"), cb = function(t) {
        if (!hb(t)) return ab(t, lb) || ab(t, "@@iterator") || db[rb(t)];
    }, ub = B, pb = Pt, gb = oi, fb = Tt, mb = cb, yb = TypeError, bb = B, vb = oi, wb = zt, _b = Qe, xb = B, Eb = oi, Ob = Tt, Cb = function(t) {
        return void 0 !== t && (ob.Array === t || nb[sb] === t);
    }, kb = Hi, Sb = ht, Tb = function(t, e) {
        var i = arguments.length < 2 ? mb(t) : e;
        if (pb(i)) return gb(ub(i, t));
        throw new yb(fb(t) + " is not iterable");
    }, Mb = cb, Db = function(t, e, i) {
        var o, s;
        vb(t);
        try {
            if (!(o = wb(t, "return"))) {
        ...
        if (s) throw o;
        return vb(o), i;
    }, Ib = TypeError, Pb = function(t, e) {
        this.stopped = t, this.result = e;
    }, Bb = Pb.prototype, Fb = function(t, e, i) {
        var o, s, n, r, a, h, d, l = i && i.that, c = !(!i || !i.AS_ENTRIES), u = !(!i || !i.IS_RECORD), p = !(!i || !i.IS_ITERATOR), g = !(!i || !i.INTERRUPTED), f = _b(e, l), m = function(t) {
        ...
        return new Pb(!1);
    }, zb = ht, Nb = TypeError, Ab = function(t, e) {
        if (zb(e, t)) return t;
        throw new Nb("Incorrect invocation");
    }, Rb = Mi, jb = n, Lb = ib, Hb = r, Wb = yi, Vb = Fb, qb = Ab, Ub = T, Yb = et, Xb = Y, Kb = wr, Gb = $e.f, Zb = Ur.forEach, Qb = D, $b = Ar.set, Jb = Ar.getterFor, tv = function(t, e, i) {
        var o, s = -1 !== t.indexOf("Map"), n = -1 !== t.indexOf("Weak"), r = s ? "set" : "add", a = jb[t], h = a && a.prototype, d = {};
    ...
    }, ev = Kn, iv = function(t, e, i) {
        for(var o in e)i && i.unsafe && t[o] ? t[o] = e[o] : ev(t, o, e[o], i);
        return t;
    }, ov = at, sv = Zn, nv = D, rv = pe("species"), av = In, hv = Zn, dv = iv, lv = Qe, cv = Ab, uv = Y, pv = Fb, gv = Zd, fv = Qd, mv = function(t) {
        var e = ov(t);
        nv && e && !e[rv] && sv(e, rv, {
            configurable: !0,
            get: function() {
    ...
    }, yv = D, bv = ib.fastKey, vv = Ar.set, wv = Ar.getterFor, _v = {
        getConstructor: function(t, e, i, o) {
            ...
            }), n = s.prototype, r = wv(e), a = function(t, e, i) {
                var o, s, n = r(t), a = h(t, e);
            ...
            return dv(n, {
                ...
                delete: function(t) {
                    var e = this, i = r(e), o = h(e, t);
                    if (o) {
                        var s = o.next, n = o.previous;
        ...
        setStrong: function(t, e, i) {
            var o = e + " Iterator", s = wv(e), n = wv(o);
            gv(t, e, function(t, e) {
                vv(this, {
                    type: o,
                    target: t,
                ...
                return t.target && (t.last = i = i ? i.next : t.state.first) ? fv("keys" === e ? i.key : "values" === e ? i.value : [
                    i.key,
                    i.value
                ], !1) : (t.target = void 0, fv(void 0, !0));
    ...
    var xv = y, Ev = Bi, Ov = nn, Cv = G, kv = xv("".charAt), Sv = xv("".charCodeAt), Tv = xv("".slice), Mv = function(t) {
        return function(e, i) {
            var o, s, n = Ov(Cv(e)), r = Ev(i), a = n.length;
        ...
        codeAt: Mv(!1),
        charAt: Mv(!0)
    }.charAt, Iv = nn, Pv = Ar, Bv = Zd, Fv = Qd, zv = "String Iterator", Nv = Pv.set, Av = Pv.getterFor(zv);
    Bv(String, "String", function(t) {
        ...
        var t, e = Av(this), i = e.string, o = e.index;
    ...
    class jv {
        ...
        setOptions(t) {
            ...
            if (void 0 !== t) {
                for(const i in t)if (Object.prototype.hasOwnProperty.call(t, i) && -1 === Mp(e).call(e, i)) {
                    const e = t[i];
                    this.add(i, e);
                }
            }
        ...
        get(t) {
            let e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], i = this._groups.get(t);
    ...
    var Lv = o(it.Number.isNaN), Hv = n.isFinite, Wv = Number.isFinite || function(t) {
    ...
    var Vv = o(it.Number.isFinite), qv = Ur.some;
    Mi({
        target: "Array",
        proto: !0,
        forced: !nc("some")
    ...
    var Uv = zo("Array").some, Yv = ht, Xv = Uv, Kv = Array.prototype, Gv = function(t) {
        var e = t.some;
    ...
    var ew = it.Object, iw = Qv.exports = function(t, e, i) {
        return ew.defineProperty(t, e, i);
    };
    ew.defineProperty.sham && (iw.sham = !0);
    var ow = Qv.exports, sw = o(ow), nw = pe, rw = $e.f, aw = nw("metadata"), hw = Function.prototype;
    void 0 === hw[aw] && rw(hw, aw, {
        value: null
    }), rr("asyncDispose"), rr("dispose"), rr("metadata");
    var dw = fl, lw = y, cw = at("Symbol"), uw = cw.keyFor, pw = lw(cw.prototype.valueOf), gw = cw.isRegisteredSymbol || function(t) {
        try {
    ...
    var Dw = o(dw), Iw = o(Qn.f("iterator"));
    function Pw(t) {
    ...
    var Nw = n, Aw = r, Rw = nn, jw = np.trim, Lw = Qu, Hw = y("".charAt), Ww = Nw.parseFloat, Vw = Nw.Symbol, qw = Vw && Vw.iterator, Uw = 1 / Ww(Lw + "-0") != -1 / 0 || qw && !Aw(function() {
        Ww(Object(qw));
    }) ? function(t) {
        var e = jw(Rw(t)), i = Ww(e);
    ...
    var Yw = o(it.parseFloat), Xw = Mi, Kw = r, Gw = zn.f;
    Xw({
        target: "Object",
        stat: !0,
        forced: Kw(function() {
    ...
    var Zw = it.Object, Qw = function(t) {
        return Zw.getOwnPropertyNames(t);
    }, $w = o(Qw), Jw = o(it.Object.getOwnPropertySymbols), t_ = {
        exports: {}
    }, e_ = Mi, i_ = r, o_ = $, s_ = M.f, n_ = D;
    e_({
        target: "Object",
        stat: !0,
    ...
    var r_ = it.Object, a_ = t_.exports = function(t, e) {
        return r_.getOwnPropertyDescriptor(t, e);
    };
    r_.getOwnPropertyDescriptor.sham && (a_.sham = !0);
    var h_ = o(t_.exports), d_ = Wl, l_ = $, c_ = M, u_ = os;
    Mi({
        target: "Object",
        stat: !0,
        sham: !D
    ...
    var p_ = o(it.Object.getOwnPropertyDescriptors), g_ = {
        exports: {}
    }, f_ = Mi, m_ = D, y_ = rn.f;
    f_({
        target: "Object",
    ...
    var b_ = it.Object, v_ = g_.exports = function(t, e) {
        return b_.defineProperties(t, e);
    };
    b_.defineProperties.sham && (v_.sham = !0);
    var w_ = o(g_.exports), __ = o(ow);
    function x_(t, e) {
        const i = [
            "node",
            "edge",
    ...
    function E_(t, e, i) {
        ...
        const o = t.x + t.width, s = t.y + t.width;
    ...
    function C_(t, e, i, o) {
        ...
        if ("function" == typeof o.distanceToBorder) {
            const i = o.distanceToBorder(t, e), r = Math.sin(e) * i, a = Math.cos(e) * i;
    ...
    var k_ = zo("Array").values, S_ = us, T_ = Jt, M_ = ht, D_ = k_, I_ = Array.prototype, P_ = {
        DOMTokenList: !0,
        NodeList: !0
    }, B_ = function(t) {
        var e = t.values;
    ...
    class z_ {
        ...
        _add(t, e) {
            ...
            let o = e;
            void 0 !== e && "" !== e || (o = " ");
            const s = this.measureText(o, i), n = wo({}, F_(s));
    ...
    class A_ {
        ...
        match(t) {
            ...
            const [i, o] = this.prepareRegExp(t), s = i.test(this.text.substr(this.position, o));
    ...
    class R_ {
        ...
        splitStringIntoLines(t) {
            let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "normal", i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            ...
            for(; o.length > 0;){
                ...
                if (0 === t) {
                    const t = o[0], i = this.getLongestFitWord(t);
    ...
    class L_ {
        ...
        setOptions(t) {
            if (this.elementOptions = t, this.initFontOptions(t.font), O_(t.label) ? this.labelDirty = !0 : t.label = void 0, void 0 !== t.font && null !== t.font) {
        ...
        propagateFonts(t) {
            ...
            for(let t = 0; t < j_.length; ++t){
                const i = j_[t], o = this.fontOptions[i];
        ...
        _drawText(t, e, i) {
            let o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "middle", s = arguments.length > 4 ? arguments[4] : void 0;
        ...
        getTextSize(t) {
            let e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
        ...
        getSize() {
            let t = this.size.left, e = this.size.top - 1;
            if (this.isEdgeLabel) {
        ...
        calculateLabelSize(t, e, i) {
            let o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0, n = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : "middle";
    ...
    class H_ {
        ...
        getDimensionsFromLabel(t, e, i) {
            ...
            let o = this.textSize.width, s = this.textSize.height;
    ...
    let W_ = class extends H_ {
        ...
        resize(t) {
            let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.selected, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.hover;
    ...
    class V_ extends H_ {
        ...
        _drawImageAtPosition(t, e) {
            if (0 != this.imageObj.width) {
                ...
                const o = this._getImagePadding(), s = this.left + o.left, n = this.top + o.top, r = this.width - o.left - o.right, a = this.height - o.top - o.bottom;
    ...
    let q_ = class extends V_ {
        ...
        resize(t) {
            let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.selected, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.hover;
            if (this.needsRefresh(e, i)) {
                const o = this.getDimensionsFromLabel(t, e, i), s = Math.max(o.width + this.margin.right + this.margin.left, o.height + this.margin.top + this.margin.bottom);
    ...
    class Y_ extends H_ {
        ...
        resize(t) {
            let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.selected, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.hover, o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {
    ...
    function K_(t) {
        for(var e = 1; e < arguments.length; e++){
            var i, o, s = null != arguments[e] ? arguments[e] : {};
    ...
    class J_ extends H_ {
        ...
        distanceToBorder(t, e) {
            t && this.resize(t);
            const i = .5 * this.width, o = .5 * this.height, s = Math.sin(e) * i, n = Math.cos(e) * o;
    ...
    let ex = class extends V_ {
        ...
        draw(t, e, i, o, s, n) {
            ...
            if ("top-left" === this.options.shapeProperties.coordinateOrigin ? (this.left = e, this.top = i, r += this.width / 2, a += this.height / 2) : (this.left = e - this.width / 2, this.top = i - this.height / 2), !0 === this.options.shapeProperties.useBorderWithImage) {
                const e = this.options.borderWidth, i = this.options.borderWidthSelected || 2 * this.options.borderWidth, r = (o ? i : e) / this.body.view.scale;
                t.lineWidth = Math.min(this.width, r), t.beginPath();
                let a = o ? this.options.color.highlight.border : s ? this.options.color.hover.border : this.options.color.border, h = o ? this.options.color.highlight.background : s ? this.options.color.hover.background : this.options.color.background;
    ...
    class lx {
        ...
        updateLabelModule(t) {
            ...
            const e = this.grouplist.get(this.options.group, !1), i = [
                t,
                this.options,
                e,
                this.globalOptions,
        ...
        setValueRange(t, e, i) {
            if (void 0 !== this.options.value) {
                const o = this.options.scaling.customScalingFunction(t, e, i, this.options.value), s = this.options.scaling.max - this.options.scaling.min;
    ...
    class cx {
        ...
        setData(t) {
            ...
            else if (Vl(t)) this.body.data.nodes = new e.DataSet, this.body.data.nodes.add(t);
            else {
        ...
        add(t) {
            ...
            for(let i = 0; i < t.length; i++){
                e = t[i];
                const s = this.body.data.nodes.get(e), n = this.create(s);
        ...
        storePositions() {
            const t = [], e = this.body.data.nodes.getDataSet();
            for (const i of e.get()){
                const e = i.id, o = this.body.nodes[e], s = Math.round(o.x), n = Math.round(o.y);
                i.x === s && i.y === n || t.push({
                    id: e,
                    x: s,
                    y: n
    ...
    var ux = Mi, px = Math.hypot, gx = Math.abs, fx = Math.sqrt;
    ux({
        target: "Math",
        stat: !0,
        arity: 2,
    ...
    class yx {
        static transform(t, e) {
            ...
            const i = e.point.x, o = e.point.y, s = e.angle, n = e.length;
            for(let e = 0; e < t.length; ++e){
                const r = t[e], a = r.x * Math.cos(s) - r.y * Math.sin(s), h = r.x * Math.sin(s) + r.y * Math.cos(s);
                r.x = i + n * a, r.y = o + n * h;
            }
        }
        static drawPath(t, e) {
    ...
    let bx, vx = class extends yx {
        static draw(t, e) {
            if (e.image) {
                t.save(), t.translate(e.point.x, e.point.y), t.rotate(Math.PI / 2 + e.angle);
                const i = null != e.imageWidth ? e.imageWidth : e.image.width, o = null != e.imageHeight ? e.imageHeight : e.image.height;
    ...
    class xx {
        static draw(t, e) {
            ...
            const o = Math.PI, s = e.angle - o / 2, n = e.angle + o / 2;
    ...
    class Ex {
        static draw(t, e) {
            ...
            yx.transform(i, e), t.strokeStyle = t.fillStyle, t.fillStyle = "rgba(0, 0, 0, 0)";
            const o = Math.PI, s = e.angle + o / 2, n = e.angle + 3 * o / 2;
            return t.beginPath(), t.arc(i.x, i.y, .4 * e.length, s, n, !1), t.stroke(), !0;
        }
    }
    class Ox {
    ...
    class Fx {
        ...
        _drawDashedLine(t, e, i, o, s) {
            t.lineCap = "round";
            const n = Vl(e.dashes) ? e.dashes : [
                5,
                5
            ];
            if (void 0 !== t.setLineDash) {
                if (t.save(), t.setLineDash(n), t.lineDashOffset = 0, this.from != this.to) this._line(t, e, i);
                else {
                    const [i, o, s] = this._getCircleData(t);
                    this._circle(t, e, i, o, s);
                }
                ...
                if (this.from != this.to) Yo(t, this.from.x, this.from.y, this.to.x, this.to.y, n);
                else {
                    const [i, o, s] = this._getCircleData(t);
                    this._circle(t, e, i, o, s);
                }
        ...
        _findBorderPositionCircle(t, e, i) {
            const o = i.x, s = i.y;
            let n = i.low, r = i.high;
            const a = i.direction, h = this.options.selfReference.size;
            let d, l = .5 * (n + r), c = 0;
            ...
            do {
                ...
                const i = Math.atan2(t.y - d.y, t.x - d.x), p = t.distanceToBorder(e, i) + c - Math.sqrt(Math.pow(d.x - t.x, 2) + Math.pow(d.y - t.y, 2));
        ...
        getColor(t, e) {
            if (!1 !== e.inheritsColor) {
                if ("both" === e.inheritsColor && this.from.id !== this.to.id) {
                    ...
                    let o = this.from.options.color.highlight.border, s = this.to.options.color.highlight.border;
        ...
        _circle(t, e, i, o, s) {
            ...
            if (!this.options.selfReference.renderBehindTheNode) {
                const e = this.options.selfReference.angle, s = this.options.selfReference.angle + Math.PI, a = this._findBorderPositionCircle(this.from, t, {
                    x: i,
                    y: o,
                    low: e,
                    high: s,
        ...
        getDistanceToEdge(t, e, i, o, s, n) {
            ...
            {
                const [t, e, i] = this._getCircleData(void 0), o = t - s, r = e - n;
        ...
        getArrowData(t, e, i, o, s, n) {
            ...
            if (h != d) {
                ...
                if ("middle" !== e) if (!0 === this.options.smooth.enabled) {
                    ...
                    const t = (l ? -o : o) / 2, e = this.getPoint(.5 + t, i), s = this.getPoint(.5 - t, i);
                    r = Math.atan2(e.y - s.y, e.x - s.x), a = this.getPoint(.5, i);
                }
            } else {
                const [i, o, s] = this._getCircleData(t);
                if ("from" === e) {
                    const e = this.options.selfReference.angle, s = this.options.selfReference.angle + Math.PI, n = this._findBorderPositionCircle(this.from, t, {
                        x: i,
                        y: o,
                        low: e,
                        high: s,
    ...
    class Ax extends Fx {
        ...
        _findBorderPositionBezier(t, e) {
            ...
            let o, s, n = !1, r = 1, a = 0, h = this.to, d = this.options.endPointOffset ? this.options.endPointOffset.to : 0;
            ...
            do {
                ...
                const t = Math.atan2(h.y - o.y, h.x - o.x), c = h.distanceToBorder(e, t) + d - Math.sqrt(Math.pow(o.x - h.x, 2) + Math.pow(o.y - h.y, 2));
    ...
    class Rx extends Ax {
        ...
        setupSupportNode() {
            if (void 0 === this.via) {
                const t = "edgeId:" + this.id, e = this._body.functions.createNode({
                    id: t,
                    shape: "circle",
                    physics: !0,
                    hidden: !0
        ...
        getPoint(t) {
            ...
            if (this.from === this.to) {
                const [e, i, o] = this._getCircleData(), s = 2 * Math.PI * (1 - t);
                return {
                    x: e + o * Math.sin(s),
    ...
    class jx extends Ax {
        ...
        _getViaCoordinates() {
            const t = this.options.smooth.roundness, e = this.options.smooth.type;
            let i = Math.abs(this.from.x - this.to.x), o = Math.abs(this.from.y - this.to.y);
            if ("discrete" === e || "diagonalCross" === e) {
                let s, n;
                s = n = i <= o ? t * o : t * i, this.from.x > this.to.x && (s = -s), this.from.y >= this.to.y && (n = -n);
                let r = this.from.x + s, a = this.from.y + n;
            ...
            if ("curvedCW" === e) {
                ...
                const e = Math.sqrt(i * i + o * o), s = Math.PI, n = (Math.atan2(o, i) + (.5 * t + .5) * s) % (2 * s);
                return {
            ...
            }
            {
                ...
                let n = this.from.x + e, r = this.from.y + s;
    ...
    class Lx extends Ax {
        ...
        _getDistanceToBezierEdge2(t, e, i, o, s, n, r, a) {
            ...
            for(let u = 1; u < 10; u++){
                ...
                const g = c[0] * t + c[1] * r.x + c[2] * a.x + c[3] * i, f = c[0] * e + c[1] * r.y + c[2] * a.y + c[3] * o;
                if (u > 0) {
    ...
    class Hx extends Lx {
        ...
        _getViaCoordinates() {
            const t = this.from.x - this.to.x, e = this.from.y - this.to.y;
            let i, o, s, n;
    ...
    class Wx extends Fx {
        ...
        _findBorderPosition(t, e) {
            let i = this.to, o = this.from;
            t.id === this.from.id && (i = this.from, o = this.to);
            const s = Math.atan2(i.y - o.y, i.x - o.x), n = i.x - o.x, r = i.y - o.y, a = Math.sqrt(n * n + r * r), h = (a - t.distanceToBorder(e, s)) / a;
            return {
                x: (1 - h) * o.x + h * i.x,
                y: (1 - h) * o.y + h * i.y,
                t: 0
    ...
    class Vx {
        ...
        static parseOptions(t, e) {
            let i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, s = arguments.length > 4 && void 0 !== arguments[4] && arguments[4];
            if (wm([
                "endPointOffset",
                "arrowStrikethrough",
                "id",
            ...
            if (void 0 !== e.color && null !== e.color) {
                ...
                if (s) xm(r, o.color, !1, i);
                else for(const t in r)Object.prototype.hasOwnProperty.call(r, t) && delete r[t];
                if (mm(r)) r.color = r, r.highlight = r, r.hover = r, r.inherit = !1, void 0 === n.opacity && (r.opacity = 1);
                else {
                    let t = !1;
        ...
        getFormattingValues() {
            const t = !0 === this.options.arrows.to || !0 === this.options.arrows.to.enabled, e = !0 === this.options.arrows.from || !0 === this.options.arrows.from.enabled, i = !0 === this.options.arrows.middle || !0 === this.options.arrows.middle.enabled, o = this.options.color.inherit, s = {
                toArrow: t,
        ...
        drawArrows(t) {
            const e = this.getFormattingValues();
            if (e.hidden) return;
            const i = this.edgeType.getViaNode(), o = {};
        ...
        isOverlappingWith(t) {
            if (this.connected) {
                const e = 10, i = this.from.x, o = this.from.y, s = this.to.x, n = this.to.y, r = t.left, a = t.top;
                return this.edgeType.getDistanceToEdge(i, o, s, n, r, a) < e;
            }
            return !1;
        }
        _getRotation(t) {
            const e = this.edgeType.getViaNode(), i = this.edgeType.getPoint(.5, e);
            ...
            const s = this.from.y - this.to.y, n = this.from.x - this.to.x;
    ...
    class qx {
        ...
        bindEventListeners() {
            ...
            this.body.emitter.on("_forceDisableDynamicCurves", function(t) {
                ...
                for(const e in i.body.edges)if (Object.prototype.hasOwnProperty.call(i.body.edges, e)) {
                    const s = i.body.edges[e], n = i.body.data.edges.get(e);
                    if (null != n) {
                        const e = n.smooth;
        ...
        setData(t) {
            ...
            else if (Vl(t)) this.body.data.edges = new e.DataSet, this.body.data.edges.add(t);
            else {
                if (t) throw new TypeError("Array or DataSet expected");
        ...
        add(t) {
            let e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            const i = this.body.edges, o = this.body.data.edges;
            for(let e = 0; e < t.length; e++){
                const s = t[e], n = i[s];
                n && n.disconnect();
                const r = o.get(s, {
        ...
        update(t) {
            const e = this.body.edges, i = this.body.data.edges;
            let o = !1;
            for(let s = 0; s < t.length; s++){
                const n = t[s], r = i.get(n), a = e[n];
        ...
        reconnectEdges() {
            let t;
            const e = this.body.nodes, i = this.body.edges;
        ...
        _removeInvalidEdges() {
            ...
            Cm(this.body.edges, (e, i)=>{
                const o = this.body.nodes[e.toId], s = this.body.nodes[e.fromId];
    ...
    class Ux {
        ...
        solve() {
            if (0 !== this.options.gravitationalConstant && this.physicsBody.physicsNodeIndices.length > 0) {
                let t;
                const e = this.body.nodes, i = this.physicsBody.physicsNodeIndices, o = i.length, s = this._formBarnesHutTree(e, i);
        ...
        _getForceContribution(t, e) {
            if (t.childrenCount > 0) {
                const i = t.centerOfMass.x - e.x, o = t.centerOfMass.y - e.y, s = Math.sqrt(i * i + o * o);
        ...
        _calculateForces(t, e, i, o, s) {
            ...
            const n = this.options.gravitationalConstant * s.mass * o.options.mass / Math.pow(t, 3), r = e * n, a = i * n;
            this.physicsBody.forces[o.id].x += r, this.physicsBody.forces[o.id].y += a;
        }
        _formBarnesHutTree(t, e) {
            let i;
            const o = e.length;
            let s = t[e[0]].x, n = t[e[0]].y, r = t[e[0]].x, a = t[e[0]].y;
            for(let i = 1; i < o; i++){
                const o = t[e[i]], h = o.x, d = o.y;
                o.options.mass > 0 && (h < s && (s = h), h > r && (r = h), d < n && (n = d), d > a && (a = d));
            }
            const h = Math.abs(r - s) - Math.abs(a - n);
            h > 0 ? (n -= .5 * h, a += .5 * h) : (s += .5 * h, r -= .5 * h);
            const d = Math.max(1e-5, Math.abs(r - s)), l = .5 * d, c = .5 * (s + r), u = .5 * (n + a), p = {
                root: {
                    centerOfMass: {
                        x: 0,
                        y: 0
        ...
        _updateBranchMass(t, e) {
            const i = t.centerOfMass, o = t.mass + e.options.mass, s = 1 / o;
    ...
    class Yx {
        ...
        solve() {
            let t, e, i, o, s, n, r, a;
            const h = this.body.nodes, d = this.physicsBody.physicsNodeIndices, l = this.physicsBody.forces, c = this.options.nodeDistance, u = -2 / 3 / c;
    ...
    class Xx {
        ...
        solve() {
            const t = this.body.nodes, e = this.physicsBody.physicsNodeIndices, i = this.physicsBody.forces, o = this.options.nodeDistance;
            for(let s = 0; s < e.length - 1; s++){
                const n = t[e[s]];
                for(let r = s + 1; r < e.length; r++){
                    const s = t[e[r]];
                    if (n.level === s.level) {
                        const t = o + this.overlapAvoidanceFactor * ((n.shape.radius || 0) / 2 + (s.shape.radius || 0) / 2), e = s.x - n.x, r = s.y - n.y, a = Math.sqrt(e * e + r * r), h = .05;
                        let d;
    ...
    class Kx {
        ...
        solve() {
            let t, e;
            const i = this.physicsBody.physicsEdgeIndices, o = this.body.edges;
            let s, n, r;
        ...
        _calculateSpringForce(t, e, i) {
            const o = t.x - e.x, s = t.y - e.y, n = Math.max(Math.sqrt(o * o + s * s), .01), r = this.options.springConstant * (i - n) / n, a = o * r, h = s * r;
    ...
    class Gx {
        ...
        solve() {
            let t, e, i, o, s, n, r, a;
            const h = this.body.edges, d = .5, l = this.physicsBody.physicsEdgeIndices, c = this.physicsBody.physicsNodeIndices, u = this.physicsBody.forces;
            ...
            const y = f / c.length, b = m / c.length;
            for(let t = 0; t < c.length; t++){
                const e = c[t];
                u[e].x -= y, u[e].y -= b;
            }
    ...
    class Zx {
        ...
        solve() {
            let t, e, i, o;
            const s = this.body.nodes, n = this.physicsBody.physicsNodeIndices, r = this.physicsBody.forces;
    ...
    class Qx extends Ux {
        ...
        _calculateForces(t, e, i, o, s) {
            ...
            const n = o.edges.length + 1, r = this.options.gravitationalConstant * s.mass * o.options.mass * n / Math.pow(t, 2), a = e * r, h = i * r;
    ...
    class $x extends Zx {
        ...
        _calculateForces(t, e, i, o, s) {
            if (t > 0) {
                const t = s.edges.length + 1, n = this.options.centralGravity * t * s.options.mass;
                o[s.id].x = e * n, o[s.id].y = i * n;
            }
        }
    }
    class Jx {
        ...
        setOptions(t) {
            if (void 0 !== t) if (!1 === t) this.options.enabled = !1, this.physicsEnabled = !1, this.stopSimulation();
            else if (!0 === t) this.options.enabled = !0, this.physicsEnabled = !0, this.startSimulation();
            else {
                this.physicsEnabled = !0, _m([
                    "stabilization"
                ], this.options, t), Nm(this.options, t, "stabilization"), void 0 === t.enabled && (this.options.enabled = !0), !1 === this.options.enabled && (this.physicsEnabled = !1, this.stopSimulation());
        ...
        updatePhysicsData() {
            ...
            const t = this.body.nodes, e = this.body.edges;
        ...
        revert() {
            const t = Jl(this.previousStates), e = this.body.nodes, i = this.physicsBody.velocities;
            this.referenceState = {};
        ...
        _evaluateStepQuality() {
            let t, e, i;
            const o = this.body.nodes, s = this.referenceState;
        ...
        moveNodes() {
            ...
            let e = 0, i = 0;
            for(let o = 0; o < t.length; o++){
                const s = t[o], n = this._performStep(s);
                e = Math.max(e, n), i += n;
            }
        ...
        _performStep(t) {
            const e = this.body.nodes[t], i = this.physicsBody.forces[t];
        ...
        _stabilizationBatch() {
            const t = ()=>!1 === this.stabilized && this.stabilizationIterations < this.targetIterations, e = ()=>{
        ...
        _drawForces(t) {
            for(let e = 0; e < this.physicsBody.physicsNodeIndices.length; e++){
                const i = this.physicsBody.physicsNodeIndices[e], o = this.body.nodes[i], s = this.physicsBody.forces[i], n = 20, r = .03, a = Math.sqrt(Math.pow(s.x, 2) + Math.pow(s.x, 2)), h = Math.min(Math.max(5, a), 15), d = 3 * h, l = Pm((180 - 180 * Math.min(1, Math.max(0, r * a))) / 360, 1, 1), c = {
                    x: o.x + n * s.x,
                    y: o.y + n * s.y
                };
    ...
    class nE {
        constructor(){}
        static getRange(t) {
            let e, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], o = 1e9, s = -1e9, n = 1e9, r = -1e9;
    ...
    class aE {
        ...
        clusterByEdgeCount(t, e) {
            ...
            for(let i = 0; i < this.body.nodeIndices.length; i++){
                const h = {}, d = {}, l = this.body.nodeIndices[i], c = this.body.nodes[l];
                if (void 0 === s[l]) {
                    a = 0, r = [];
        ...
        clusterByConnection(t, e) {
            ...
            const n = {}, r = {}, a = s.id, h = nE.cloneOptions(s);
            n[a] = s;
            for(let t = 0; t < s.edges.length; t++){
                const i = s.edges[t];
                if (void 0 === this.clusteredEdges[i.id]) {
                    const t = this._getConnectedId(i, a);
                    if (void 0 === this.clusteredNodes[t]) if (t !== a) if (void 0 === e.joinCondition) r[i.id] = i, n[t] = this.body.nodes[t];
                    else {
        ...
        _createClusterEdges(t, e, i, o) {
            ...
            const u = [], p = function(t) {
                for(let e = 0; e < u.length; e++){
                    const i = u[e], o = t.fromId === i.fromId && t.toId === i.toId, s = t.fromId === i.toId && t.toId === i.fromId;
                    if (o || s) return i;
                }
                return null;
            };
            for(let t = 0; t < c.length; t++){
                const e = c[t], i = e.edge;
                let s = p(e);
        ...
        _getClusterPosition(t) {
            const e = Jl(t);
            let i, o = t[e[0]].x, s = t[e[0]].x, n = t[e[0]].y, r = t[e[0]].y;
        ...
        _getHubSize() {
            ...
            t /= i, e /= i;
            const s = e - Math.pow(t, 2), n = Math.sqrt(s);
        ...
        _createClusteredEdge(t, e, i, o, s) {
            ...
            return r.clusteringEdgeReplacingIds = [
                i.id
            ], r.connect(), this.body.edges[r.id] = r, r;
        }
        ...
        _updateState() {
            ...
            Cm(Jl(this.body.edges), (t)=>{
                const e = this.body.edges[t], i = this._isClusteredNode(e.fromId) || this._isClusteredNode(e.toId);
            ...
            for(; n;){
                const t = [];
                o(function(e) {
                    const i = Jl(e.containedNodes).length, o = !0 === e.options.allowSingleNodeCluster;
    ...
    class hE {
        ...
        _redraw() {
            ...
            if (!0 === this.allowRedraw) {
                ...
                const i = this.canvas.getContext(), o = this.canvas.frame.canvas.clientWidth, s = this.canvas.frame.canvas.clientHeight;
        ...
        _drawNodes(t) {
            let e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            const i = this.body.nodes, o = this.body.nodeIndices;
            let s;
            const n = [], r = [], a = this.canvas.DOMtoCanvas({
                x: -20,
                y: -20
            ...
            for(let a = 0; a < o.length; a++)if (s = i[o[a]], s.hover) r.push(o[a]);
            else if (s.isSelected()) n.push(o[a]);
            else if (!0 === e) {
                const e = s.draw(t);
        ...
        _drawEdges(t) {
            const e = this.body.edges, i = this.body.edgeIndices;
        ...
        _drawSelectionBox(t) {
            if (this.body.selectionBox.show) {
                t.beginPath();
                const e = this.body.selectionBox.position.end.x - this.body.selectionBox.position.start.x, i = this.body.selectionBox.position.end.y - this.body.selectionBox.position.start.y;
    ...
    class uE {
        ...
        _setCameraState() {
            if (void 0 !== this.cameraState.scale && 0 !== this.frame.canvas.clientWidth && 0 !== this.frame.canvas.clientHeight && 0 !== this.pixelRatio && this.cameraState.previousWidth > 0 && this.cameraState.previousHeight > 0) {
                const t = this.frame.canvas.width / this.pixelRatio / this.cameraState.previousWidth, e = this.frame.canvas.height / this.pixelRatio / this.cameraState.previousHeight;
        ...
        setSize() {
            let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.options.width, e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.options.height;
            t = this._prepareValue(t), e = this._prepareValue(e);
            let i = !1;
            const o = this.frame.canvas.width, s = this.frame.canvas.height, n = this.pixelRatio;
            if (this._setPixelRatio(), t != this.options.width || e != this.options.height || this.frame.style.width != t || this.frame.style.height != e) this._getCameraState(n), this.frame.style.width = t, this.frame.style.height = e, this.frame.canvas.style.width = "100%", this.frame.canvas.style.height = "100%", this.frame.canvas.width = Math.round(this.frame.canvas.clientWidth * this.pixelRatio), this.frame.canvas.height = Math.round(this.frame.canvas.clientHeight * this.pixelRatio), this.options.width = t, this.options.height = e, this.canvasViewCenter = {
                ...
                const t = Math.round(this.frame.canvas.clientWidth * this.pixelRatio), e = Math.round(this.frame.canvas.clientHeight * this.pixelRatio);
    ...
    class pE {
        ...
        fit(t) {
            ...
            const i = this.canvas.frame.canvas.clientWidth, o = this.canvas.frame.canvas.clientHeight;
            let s, n;
            if (0 === i || 0 === o) n = 1, s = nE.getRange(this.body.nodes, t.nodes);
            else if (!0 === e) {
                let e = 0;
                ...
                const e = i / (1.1 * Math.abs(s.maxX - s.minX)), r = o / (1.1 * Math.abs(s.maxY - s.minY));
                n = e <= r ? e : r;
            }
        ...
        animateView(t) {
            ...
            }), i = e.x - t.position.x, o = e.y - t.position.y;
            var s, n;
        ...
        _lockedRedraw() {
            const t = this.body.nodes[this.lockedOnNodeId].x, e = this.body.nodes[this.lockedOnNodeId].y, i = this.canvas.DOMtoCanvas({
                x: .5 * this.canvas.frame.canvas.clientWidth,
                y: .5 * this.canvas.frame.canvas.clientHeight
            }), o = i.x - t, s = i.y - e, n = this.body.view.translation, r = {
    ...
    function gE(t) {
        var e, i = t && t.preventDefault || !1, o = t && t.container || window, s = {}, n = {
            keydown: {},
            keyup: {}
        }, r = {};
    ...
    class fE {
        ...
        loadNavigationElements() {
            ...
            for(let s = 0; s < t.length; s++){
                ...
                var i, o;
                if ("_fit" === e[s]) lE(n, Ho(i = this._fit).call(i, this));
                else lE(n, Ho(o = this.bindToRedraw).call(o, this, e[s]));
        ...
        _zoomIn() {
            const t = this.body.view.scale, e = this.body.view.scale * (1 + this.options.keyboard.speed.zoom), i = this.body.view.translation, o = e / t, s = (1 - o) * this.canvas.canvasViewCenter.x + i.x * o, n = (1 - o) * this.canvas.canvasViewCenter.y + i.y * o;
    ...
    class mE {
        ...
        setOptions(t) {
            if (void 0 !== t) {
                ...
                ], this.options, t), Nm(this.options, t, "keyboard"), t.tooltip && (wo(this.options.tooltip, t.tooltip), t.tooltip.color && (this.options.tooltip.color = Mm(t.tooltip.color)));
            }
        ...
        onTap(t) {
            const e = this.getPointer(t.center), i = this.selectionHandler.options.multiselect && (t.changedPointers[0].ctrlKey || t.changedPointers[0].metaKey);
        ...
        onHold(t) {
            const e = this.getPointer(t.center), i = this.selectionHandler.options.multiselect;
        ...
        onDrag(t) {
            ...
            const e = this.getPointer(t.center), i = this.drag.selection;
            if (i && i.length && !0 === this.options.dragNodes) {
                this.selectionHandler.generateClickEvent("dragging", t, e);
                const o = e.x - this.drag.pointer.x, s = e.y - this.drag.pointer.y;
                mc(i).call(i, (t)=>{
                    const e = t.node;
                ...
                if (!0 === this.options.dragView && !t.srcEvent.shiftKey) {
                    if (this.selectionHandler.generateClickEvent("dragging", t, e, void 0, !0), void 0 === this.drag.pointer) return void this.onDragStart(t);
                    const i = e.x - this.drag.pointer.x, o = e.y - this.drag.pointer.y;
        ...
        onDragEnd(t) {
            if (this.drag.dragging = !1, this.body.selectionBox.show) {
                ...
                const i = this.body.selectionBox.position, o = {
        ...
        zoom(t, e) {
            if (!0 === this.options.zoomView) {
                ...
                const s = this.body.view.translation, n = t / i, r = (1 - n) * e.x + s.x * n, a = (1 - n) * e.y + s.y * n;
        ...
        _checkShowPopup(t) {
            const e = this.canvas._XconvertDOMtoCanvas(t.x), i = this.canvas._YconvertDOMtoCanvas(t.y), o = {
                left: e,
                top: i,
                right: e,
                bottom: i
            ...
            if (void 0 === this.popupObj) {
                const t = this.body.nodeIndices, e = this.body.nodes;
                let i;
                const s = [];
            ...
            if (void 0 === this.popupObj && !1 === n) {
                const t = this.body.edgeIndices, e = this.body.edges;
                let i;
                const s = [];
    ...
    var yE = o(it.Set), bE = y, vE = iv, wE = ib.getWeakData, _E = Ab, xE = oi, EE = Y, OE = et, CE = Fb, kE = Jt, SE = Ar.set, TE = Ar.getterFor, ME = Ur.find, DE = Ur.findIndex, IE = bE([].splice), PE = 0, BE = function(t) {
    ...
    var NE, AE = {
        getConstructor: function(t, e, i, o) {
            ...
            }), n = s.prototype, r = TE(e), a = function(t, e, i) {
                var o = r(t), s = wE(xE(e), !0);
    ...
    }, RE = Ly, jE = n, LE = y, HE = iv, WE = ib, VE = tv, qE = AE, UE = et, YE = Ar.enforce, XE = r, KE = Er, GE = Object, ZE = Array.isArray, QE = GE.isExtensible, $E = GE.isFrozen, JE = GE.isSealed, tO = GE.freeze, eO = GE.seal, iO = {}, oO = {}, sO = !jE.ActiveXObject && "ActiveXObject" in jE, nO = function(t) {
        return function() {
            return t(this, arguments.length ? arguments[0] : void 0);
        };
    }, rO = VE("WeakMap", nO, qE), aO = rO.prototype, hO = LE(aO.set);
    if (KE) if (sO) {
        NE = qE.getConstructor(nO, "WeakMap", !0), WE.enable();
        var dO = LE(aO.delete), lO = LE(aO.has), cO = LE(aO.get);
        HE(aO, {
            delete: function(t) {
                if (UE(t) && !QE(t)) {
                    var e = YE(this);
    ...
    var uO, pO, gO, fO, mO, yO = o(it.WeakMap);
    function bO(t, e, i, o) {
    ...
    class _O {
        ...
        getChanges() {
            return {
                added: [
                    ...wO(bO(this, uO, "f"), bO(this, pO, "f"))
                ],
                deleted: [
                    ...wO(bO(this, pO, "f"), bO(this, uO, "f"))
                ],
                previous: [
                    ...new yE(bO(this, uO, "f"))
                ],
    ...
    class EO {
        ...
        getNodeAt(t) {
            let e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
            const i = this._pointerToPositionObject(t), o = this._getAllNodesOverlappingWith(i);
        ...
        getEdgeAt(t) {
            ...
            for(let t = 0; t < this.body.edgeIndices.length; t++){
                const e = this.body.edgeIndices[t], r = n[e];
                if (r.connected) {
                    const t = r.from.x, n = r.from.y, a = r.to.x, h = r.to.y, d = r.edgeType.getDistanceToEdge(t, n, a, h, i.x, i.y);
                    d < o && (s = e, o = d);
                }
            }
        ...
        hoverObject(t, e) {
            ...
            if (void 0 !== i) {
                const s = Jl(this.hoverObj.edges).length, n = Jl(this.hoverObj.nodes).length;
        ...
        commitAndEmit(t, e) {
            let i = !1;
            const o = this._selectionAccumulator.commit(), s = {
        ...
        getClickedItems(t) {
            const e = this.canvas.DOMtoCanvas(t), i = [], o = this.body.nodeIndices, s = this.body.nodes;
            for(let t = o.length - 1; t >= 0; t--){
                const n = s[o[t]].getItemsOnPoint(e);
                i.push.apply(i, n);
            }
            const n = this.body.edgeIndices, r = this.body.edges;
    ...
    var OO = Hn, CO = Math.floor, kO = function(t, e) {
        var i = t.length, o = CO(i / 2);
        ...
        return t;
    }, MO = kO, DO = dt.match(/firefox\/(\d+)/i), IO = !!DO && +DO[1], PO = /MSIE|Trident/.test(dt), BO = dt.match(/AppleWebKit\/(\d+)\./), FO = !!BO && +BO[1], zO = Mi, NO = y, AO = Pt, RO = Zt, jO = Hi, LO = Fc, HO = nn, WO = r, VO = MO, qO = nc, UO = IO, YO = PO, XO = mt, KO = FO, GO = [], ZO = NO(GO.sort), QO = NO(GO.push), $O = WO(function() {
        GO.sort(void 0);
    }), JO = WO(function() {
        GO.sort(null);
    }), tC = qO("sort"), eC = !WO(function() {
        if (XO) return XO < 70;
        if (!(UO && UO > 3)) {
            if (YO) return !0;
            if (KO) return KO < 603;
    ...
    var iC = zo("Array").sort, oC = ht, sC = iC, nC = Array.prototype, rC = function(t) {
        var e = t.sort;
        return t === nC || oC(nC, t) && e === nC.sort ? sC : e;
    }, aC = o(rC), hC = Pt, dC = Zt, lC = U, cC = Hi, uC = TypeError, pC = function(t) {
        return function(e, i, o, s) {
            hC(i);
            var n = dC(e), r = lC(n), a = cC(n), h = t ? a - 1 : 0, d = t ? -1 : 1;
            if (o < 2) for(;;){
                if (h in r) {
                    s = r[h], h += d;
                    break;
        ...
        left: pC(!1),
        right: pC(!0)
    }, fC = "process" === _(n.process), mC = gC.left;
    Mi({
        target: "Array",
        proto: !0,
    ...
    var yC = zo("Array").reduce, bC = ht, vC = yC, wC = Array.prototype, _C = function(t) {
        var e = t.reduce;
    ...
    var SC = zo("Array").every, TC = ht, MC = SC, DC = Array.prototype, IC = function(t) {
        var e = t.every;
    ...
    function BC(t, e) {
        ...
        return mc(t).call(t, (t)=>{
            ...
            const i = t.from.id, o = t.to.id;
            null == e[i] && (e[i] = 0), (null == e[o] || e[i] >= e[o]) && (e[o] = e[i] + 1);
        }), e;
    }
    function FC(t, e, i, o) {
        var s;
        const n = Ip(null), r = xC(s = [
            ...F_(o).call(o)
        ]).call(s, (t, e)=>t + 1 + e.edges.length, 0), a = i + "Id", h = "to" === i ? 1 : -1;
        for (const [s, c] of o){
    ...
    class zC {
        ...
        hasSameParent(t, e) {
            const i = this.parentReference[t.id], o = this.parentReference[e.id];
    ...
    class NC {
        ...
        setOptions(t, e) {
            if (void 0 !== t) {
                const i = this.options.hierarchical, o = i.enabled;
                if (wm([
                    "randomSeed",
                    "improvedLayout",
                    "clusterThreshold"
                ], this.options, t), Nm(this.options, t, "hierarchical"), void 0 !== t.randomSeed && this._resetRNG(t.randomSeed), !0 === i.enabled) return !0 === o && this.body.emitter.emit("refresh", !0), "RL" === i.direction || "DU" === i.direction ? i.levelSeparation > 0 && (i.levelSeparation *= -1) : i.levelSeparation < 0 && (i.levelSeparation *= -1), this.setDirectionStrategy(), this.body.emitter.emit("_resetHierarchicalLayout"), this.adaptAllOptionsForHierarchicalLayout(e);
        ...
        positionInitially(t) {
            if (!0 !== this.options.hierarchical.enabled) {
                ...
                const e = t.length + 50;
                for(let i = 0; i < t.length; i++){
                    const o = t[i], s = 2 * Math.PI * this._rng();
        ...
        _shiftToCenter() {
            const t = nE.getRangeCore(this.body.nodes, this.body.nodeIndices), e = nE.findCenter(t);
        ...
        _condenseHierarchy() {
            ...
            const i = {}, o = (t, e)=>{
                ...
                let i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1e9, o = 1e9, s = 1e9, n = 1e9, r = -1e9;
                for(const a in e)if (Object.prototype.hasOwnProperty.call(e, a)) {
                    const h = t.body.nodes[a], d = t.hierarchical.levels[h.id], l = t.direction.getPosition(h), [c, u] = t._getSpaceAroundNode(h, e);
                ...
                const i = this.hierarchical.getMaxLevel(t.id), o = this.hierarchical.getMaxLevel(e.id);
                return Math.min(i, o);
            }, h = (t, e, i)=>{
                const o = this.hierarchical;
                for(let s = 0; s < e.length; s++){
                    const n = e[s], r = o.distributionOrdering[n];
                ...
                const h = t.direction.getPosition(i), d = t.direction.getPosition(o), l = Math.abs(d - h), c = t.options.hierarchical.nodeSpacing;
                if (l > c) {
                    const h = {}, d = {};
                    n(i, h), n(o, d);
                    const l = a(i, o), u = r(h, l), p = r(d, l), g = u[1], f = p[0], m = p[2];
                    if (Math.abs(g - f) > c) {
                        let i = g - f + c;
                ...
                const s = o.id, a = o.edges, h = this.hierarchical.levels[o.id], d = this.options.hierarchical.levelSeparation * this.options.hierarchical.levelSeparation, l = {}, c = [];
                ...
                ((t)=>{
                    ...
                    const a = r(i[o.id]), h = a[2], d = a[3], l = t - s;
                    let c = 0;
                    ...
                    const i = this.direction.getPosition(o), [s, n] = this._getSpaceAroundNode(o), r = t - i;
                    let a = i;
                ...
                for(let o = 0; o < t; o++){
                    e = !1;
                    for(let t = 0; t < i.length; t++){
                        const e = i[t], o = this.hierarchical.distributionOrdering[e];
                ...
                t = kc(t).call(t);
                for(let e = 0; e < t.length; e++){
                    const i = t[e], o = this.hierarchical.distributionOrdering[i];
        ...
        _getSpaceAroundNode(t, e) {
            ...
            if (void 0 !== o) {
                const s = this.hierarchical.distributionIndex[t.id], n = this.direction.getPosition(t), r = this.hierarchical.distributionOrdering[o];
                let a = 1e9, h = 1e9;
                if (0 !== s) {
                    const t = r[s - 1];
        ...
        _centerParent(t) {
            if (this.hierarchical.parentReference[t.id]) {
                ...
                for(let t = 0; t < e.length; t++){
                    const i = e[t], o = this.body.nodes[i], s = this.hierarchical.childrenReference[i];
                    if (void 0 !== s) {
                        const t = this._getCenterPosition(s), e = this.direction.getPosition(o), [i, n] = this._getSpaceAroundNode(o), r = e - t;
        ...
        _placeBranchNodes(t, e) {
            ...
            for(let i = 0; i < s.length; i++){
                const o = s[i], n = this.hierarchical.levels[o.id];
            ...
            if (this.hierarchical.isTree) {
                if (void 0 !== this.lastNodeOnLevel[e]) {
                    ...
                    if (i - o < this.options.hierarchical.nodeSpacing) {
                        const s = o + this.options.hierarchical.nodeSpacing - i, n = this._findCommonParent(this.lastNodeOnLevel[e], t.id);
        ...
        _getHubSizes() {
            ...
            Cm(this.body.nodeIndices, (e)=>{
                const i = this.body.nodes[e], o = this._getActiveEdges(i).length;
                t[o] = !0;
            });
            const e = [];
            return Cm(t, (t)=>{
        ...
        _crawlNetwork() {
            let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : function() {}, e = arguments.length > 1 ? arguments[1] : void 0;
            const i = {}, o = (e, s)=>{
                if (void 0 === i[e.id]) {
                    let n;
    ...
    class AC {
        ...
        showManipulatorToolbar() {
            if (this._clean(), this.manipulationDOM = {}, !0 === this.guiEnabled) {
                ...
                const i = this.selectionHandler.getSelectedNodeCount(), o = this.selectionHandler.getSelectedEdgeCount(), s = i + o, n = this.options.locales[this.options.locale];
                let r = !1;
        ...
        editEdgeMode() {
            if (!0 !== this.editMode && this.enableEditMode(), this._clean(), this.inMode = "editEdge", "object" != typeof this.options.editEdge || "function" != typeof this.options.editEdge.editWithoutDrag || (this.edgeBeingEditedId = this.selectionHandler.getSelectedEdgeIds()[0], void 0 === this.edgeBeingEditedId)) {
                ...
                if (this.edgeBeingEditedId = this.selectionHandler.getSelectedEdgeIds()[0], void 0 !== this.edgeBeingEditedId) {
                    var e, i, o, s;
                    const t = this.body.edges[this.edgeBeingEditedId], n = this._getNewTargetNode(t.from.x, t.from.y), r = this._getNewTargetNode(t.to.x, t.to.y);
        ...
        deleteSelected() {
            ...
            const t = this.selectionHandler.getSelectedNodeIds(), e = this.selectionHandler.getSelectedEdgeIds();
            let i;
            if (t.length > 0) {
        ...
        _createEditButton() {
            ...
            const e = this.options.locales[this.options.locale], i = this._createButton("editMode", "vis-edit vis-edit-mode", e.edit || this.options.locales.en.edit);
        ...
        _unbindTemporaryEvents() {
            for(let t = 0; t < this.temporaryEventFunctions.length; t++){
                const e = this.temporaryEventFunctions[t].event, i = this.temporaryEventFunctions[t].boundFunction;
        ...
        _controlNodeDragStart() {
            const t = this.lastTouch, e = this.selectionHandler._pointerToPositionObject(t), i = this.body.nodes[this.temporaryIds.nodes[0]], o = this.body.nodes[this.temporaryIds.nodes[1]], s = this.body.edges[this.edgeBeingEditedId];
            this.selectedControlNode = void 0;
            const n = i.isOverlappingWith(e), r = o.isOverlappingWith(e);
        ...
        _controlNodeDrag(t) {
            ...
            const e = this.body.functions.getPointer(t.center), i = this.canvas.DOMtoCanvas(e);
        ...
        _controlNodeDragEnd(t) {
            const e = this.body.functions.getPointer(t.center), i = this.selectionHandler._pointerToPositionObject(e), o = this.body.edges[this.edgeBeingEditedId];
            ...
            if (void 0 !== n && void 0 !== this.selectedControlNode) if (!0 === n.isCluster) alert(this.options.locales[this.options.locale].createEdgeError || this.options.locales.en.createEdgeError);
            else {
        ...
        _handleConnect(t) {
            if ((new Date).valueOf() - this.touchTime > 100) {
                ...
                const e = this.lastTouch, i = this.selectionHandler.getNodeAt(e);
        ...
        _dragControlNode(t) {
            const e = this.body.functions.getPointer(t.center), i = this.selectionHandler._pointerToPositionObject(e);
            let o;
    ...
    const RC = "string", jC = "boolean", LC = "number", HC = "array", WC = "object", VC = [
        "arrow",
        "bar",
        "box",
        "circle",
        ...
        getDistances(t, e, i) {
            ...
            for(let t = 0; t < n; t++){
                ...
                for(let t = 0; t < n - 1; t++){
                    const r = e[t], a = o[r];
                    for(let h = t + 1; h < n; h++){
                        const t = e[h], n = o[t], d = Math.min(a[t], a[i] + s[t]);
                        a[t] = d, n[r] = d;
                    }
                }
            }
    ...
    class ZC {
        ...
        _getHighestEnergyNode(t) {
            const e = this.body.nodeIndices, i = this.body.nodes;
            let o = 0, s = e[0], n = 0, r = 0;
        ...
        _moveNode(t, e, i) {
            const o = this.body.nodeIndices, s = this.body.nodes;
            let n = 0, r = 0, a = 0;
            const h = s[t].x, d = s[t].y, l = this.K_matrix[t], c = this.L_matrix[t];
            for(let e = 0; e < o.length; e++){
                const i = o[e];
                if (i !== t) {
                    const t = s[i].x, e = s[i].y, o = l[i], u = c[i], p = 1 / ((h - t) ** 2 + (d - e) ** 2) ** 1.5;
                    n += o * (1 - u * (d - e) ** 2 * p), r += o * (u * (h - t) * (d - e) * p), a += o * (1 - u * (h - t) ** 2 * p);
                }
            }
            const u = (e / n + i / r) / (r / n - a / r), p = -(r * u + e) / n;
            s[t].x += p, s[t].y += u, this._updateE_matrix(t);
        }
        _createL_matrix(t) {
            const e = this.body.nodeIndices, i = this.springLength;
            this.L_matrix = [];
        ...
        _createK_matrix(t) {
            const e = this.body.nodeIndices, i = this.springConstant;
            this.K_matrix = [];
            for(let o = 0; o < e.length; o++){
                this.K_matrix[e[o]] = {};
        ...
        _createE_matrix() {
            ...
            for(let i = 0; i < t.length; i++){
                const o = t[i], s = e[o].x, n = e[o].y;
                let r = 0, a = 0;
                for(let h = i; h < t.length; h++){
                    const d = t[h];
                    if (d !== o) {
                        const t = e[d].x, l = e[d].y, c = 1 / Math.sqrt((s - t) ** 2 + (n - l) ** 2);
                        this.E_matrix[o][h] = [
                            this.K_matrix[o][d] * (s - t - this.L_matrix[o][d] * (s - t) * c),
                            this.K_matrix[o][d] * (n - l - this.L_matrix[o][d] * (n - l) * c)
                        ], this.E_matrix[d][i] = this.E_matrix[o][h], r += this.E_matrix[o][h][0], a += this.E_matrix[o][h][1];
                    }
                }
                this.E_sums[o] = [
                    r,
        ...
        _updateE_matrix(t) {
            const e = this.body.nodeIndices, i = this.body.nodes, o = this.E_matrix[t], s = this.K_matrix[t], n = this.L_matrix[t], r = i[t].x, a = i[t].y;
            let h = 0, d = 0;
            for(let l = 0; l < e.length; l++){
                const c = e[l];
                if (c !== t) {
                    const t = o[l], e = t[0], u = t[1], p = i[c].x, g = i[c].y, f = 1 / Math.sqrt((r - p) ** 2 + (a - g) ** 2), m = s[c] * (r - p - n[c] * (r - p) * f), y = s[c] * (a - g - n[c] * (a - g) * f);
                    o[l] = [
                        m,
                        y
                    ], h += m, d += y;
    ...
    Go(QC.prototype), QC.prototype.setOptions = function(t) {
        if (null === t && (t = void 0), void 0 !== t) {
            ...
            if (wm([
                ...
                try {
                    const [o, s] = e.split(/[-_ /]/, 2), n = null != o ? o.toLowerCase() : null, r = null != s ? s.toUpperCase() : null;
                    if (n && r) {
                        const e = n + "-" + r;
        ...
        for(const i in e)if (Object.prototype.hasOwnProperty.call(e, i)) {
            const o = e[i], s = t[o.fromId], n = t[o.toId], r = void 0 !== s && void 0 !== n;
...
//# sourceMappingURL=ba6bf_vis-network_peer_umd_vis-network_min_b9373a3a.js.map