...
"[project]/components/features/algo-studio/StaticGraphCanvas.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StaticGraphCanvas({ data, width, height, layoutType = 'circle' }) {
    ...
    const nodePositions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StaticGraphCanvas.useMemo[nodePositions]": ()=>{
            const pos = {};
            if (layoutType === 'circle') {
                const radius = Math.min(safeWidth, safeHeight) / 2 * 0.8;
                const angleStep = 2 * Math.PI / nodes.length;
                nodes.forEach({
                    "StaticGraphCanvas.useMemo[nodePositions]": (node, i)=>{
                        pos[node.id] = {
                ...
                // Build adj
                links.forEach({
                    "StaticGraphCanvas.useMemo[nodePositions]": (l)=>{
                ...
                const textNodes = nodes.filter({
                    "StaticGraphCanvas.useMemo[nodePositions].textNodes": (n)=>!nodes.some({
                            "StaticGraphCanvas.useMemo[nodePositions].textNodes": (parent)=>links.some({
                                    "StaticGraphCanvas.useMemo[nodePositions].textNodes": (l)=>{
                                        const t = typeof l.target === 'object' ? l.target.id : l.target;
                                        return t === n.id;
                                    }
                                }["StaticGraphCanvas.useMemo[nodePositions].textNodes"])
                        }["StaticGraphCanvas.useMemo[nodePositions].textNodes"])
                }["StaticGraphCanvas.useMemo[nodePositions].textNodes"]); // Heuristic: Find root (node with no incoming edges? Or just pick 0?)
                // Fallback root: 0
                ...
                if (rootId) {
                    ...
                    while(queue.length > 0){
                        ...
                        neighbors.forEach({
                            "StaticGraphCanvas.useMemo[nodePositions]": (nId)=>{
                                if (!visited.has(nId)) {
                                    visited.add(nId);
                                    levels[nId] = lvl + 1;
                                    queue.push({
                    ...
                    nodes.forEach({
                        "StaticGraphCanvas.useMemo[nodePositions]": (n)=>levels[n.id] = 0
                    }["StaticGraphCanvas.useMemo[nodePositions]"]);
                }
                ...
                Object.entries(levels).forEach({
                    "StaticGraphCanvas.useMemo[nodePositions]": ([id, lvl])=>{
                ...
                nodes.forEach({
                    "StaticGraphCanvas.useMemo[nodePositions]": (n)=>{
...
_s(StaticGraphCanvas, "BpgztRiVTgJ1vs1OmKJrGorc6y8=");
_c = StaticGraphCanvas;
var _c;
__turbopack_context__.k.register(_c, "StaticGraphCanvas");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$features$2f$algo$2d$studio$2f$StaticGraphCanvas$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/features/algo-studio/StaticGraphCanvas.tsx [app-client] (ecmascript)");
...
//# sourceMappingURL=_d80394a2._.js.map