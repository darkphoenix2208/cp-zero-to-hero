...
"[project]/node_modules/react-graph-vis/node_modules/vis-data/peer/umd/vis-data.min.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 */ !function(t, e) {
    ...
    var r = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : ("TURBOPACK compile-time truthy", 1) ? /*TURBOPACK member replacement*/ __turbopack_context__.g : "TURBOPACK unreachable";
    function n(t) {
    ...
    var ea = {
        ...
        return function(s, c, f, l) {
            for(var h, p, v = oa(s), d = na(v), y = ra(c, f), g = ia(d), m = 0, b = l || aa, w = e ? b(s, g) : r || a ? b(s, 0) : void 0; g > m; m++)if ((u || m in d) && (p = y(h = d[m], m, v), t)) if (e) w[m] = p;
            else if (p) switch(t){
                case 3:
                    return !0;
                case 5:
   ...
   * Licensed under the MIT license */ function Md() {
    ...
    function _y(t, e, r) {
        var n;
        if (t) if (t.forEach) t.forEach(e, r);
...
"[project]/node_modules/react-graph-vis/node_modules/vis-data/peer/umd/vis-data.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//# sourceMappingURL=ba6bf_vis-data_peer_umd_d74c41fd._.js.map