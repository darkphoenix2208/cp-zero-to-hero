...
"[project]/app/data:f85e35 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$c54d0e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:c54d0e [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$653f5c__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:653f5c [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$31a2e4__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:31a2e4 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$178c71__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:178c71 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$f85e35__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:f85e35 [app-client] (ecmascript) <text/javascript>");
...
function FlashbackPage() {
            ...
            const timer = setTimeout({
                "FlashbackPage.useEffect.timer": async ()=>{
                    if (query.length >= 2 && !selectedProblem) {
                        setSearching(true);
                        try {
                            const hits = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$178c71__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["searchProblems"])(query);
    ...
    const refreshCards = ()=>{
        ...
        if (handle) {
            Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$c54d0e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getDueFlashcards"])(handle),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$f85e35__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAllFlashcards"])(handle)
            ]).then(([due, all])=>{
                setCards(due);
                setAllCards(all);
                setLoading(false);
    ...
    const handleAdd = async (e)=>{
        ...
        try {
            const handle = localStorage.getItem('cp-handle');
            if (handle) {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$31a2e4__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addToReviewQueue"])(handle, selectedProblem);
                if (res.error) {
                    alert(res.error);
                } else {
    ...
    const handleRate = async (quality)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$653f5c__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["processReview"])({
            id: current.id,
            quality
        });
...
//# sourceMappingURL=_dcf0bf78._.js.map