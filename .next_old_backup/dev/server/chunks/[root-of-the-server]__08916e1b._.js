...
"[project]/app/api/dojo/assist/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        const completion = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$groq$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["groq"].chat.completions.create({
            messages: [
                ...
                {
                    role: "user",
                    content: `PROBLEM: ${problemStatement || "Unknown"}\n\nCODE:\n${code}`
                }
            ],
            model: MODEL,
            response_format: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__08916e1b._.js.map