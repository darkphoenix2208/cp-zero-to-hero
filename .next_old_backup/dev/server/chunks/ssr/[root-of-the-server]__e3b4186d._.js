...
async function getRivalActivity(handles) {
    ...
    for (const handle of handles){
        try {
            ...
            const data = await res.json();
            if (data.status === 'OK') {
                results.push(data.result.map((sub)=>({
                        ...sub,
                        handle
                    })));
            } else {
        ...
        try {
            ...
            if (data.status === 'OK') {
                ...
                results.push({
                    handle,
                    history: []
                }); // Push empty so graph doesn't break
            }
        } catch (e) {
            console.error(e);
            results.push({
...
"[project]/.next-internal/server/app/flashback/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/flashback/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3b4186d._.js.map