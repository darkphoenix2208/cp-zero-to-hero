module.exports = [
"[project]/app/data:55975a [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:059258 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:271d19 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:aac6fa [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:1b749b [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$aac6fa__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:aac6fa [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$1b749b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:1b749b [app-ssr] (ecmascript) <text/javascript>");
...
function RivalryWidget() {
    ...
    const fetchRivals = async ()=>{
        ...
        if (handle) {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$1b749b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getRivals"])(handle);
            setRivals(data);
        }
        setLoading(false);
    };
    ...
    const handleAdd = async (e)=>{
        ...
        const handle = localStorage.getItem('cp-handle');
        if (handle) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$aac6fa__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addPinnedRival"])(handle, newHandle);
            setNewHandle('');
            fetchRivals();
        }
    };
...
"[project]/app/data:55482f [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$55975a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:55975a [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$059258__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:059258 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$271d19__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:271d19 [app-ssr] (ecmascript) <text/javascript>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$55482f__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:55482f [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function DashboardClient() {
    ...
    const processStats = (u, subs)=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$271d19__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["syncUserStats"])(u.handle, {
    ...
    const handleLogin = async (e)=>{
        ...
        setLoading(true);
        setError('');
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$55975a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["verifyUser"])(handle);
        if (data) {
            setUser(data);
            localStorage.setItem('cp-handle', handle);
            // Fetch stats + recommendation
            const subs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$059258__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getSubmissions"])(handle);
            setSubmissions(subs);
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$55482f__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getProblemsByRating"])(targetRating).then((probs)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (saved) {
            setHandle(saved);
            setLoading(true);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$55975a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["verifyUser"])(saved).then(async (u)=>{
                if (u) {
                    setUser(u);
                    // Fetch stats on auto-login too
                    const subs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$059258__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getSubmissions"])(saved);
                    setSubmissions(subs);
                    processStats(u, subs);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6a9fb93c._.js.map