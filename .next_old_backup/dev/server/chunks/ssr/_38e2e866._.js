...
"[project]/app/data:757418 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:4a45a2 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:d4ffc9 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data:9aa3a0 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$757418__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:757418 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$4a45a2__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:4a45a2 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d4ffc9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:d4ffc9 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$9aa3a0__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/data:9aa3a0 [app-ssr] (ecmascript) <text/javascript>");
...
function FlashbackPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const timer = setTimeout(async ()=>{
            if (query.length >= 2 && !selectedProblem) {
                setSearching(true);
                const hits = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$9aa3a0__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["searchProblems"])(query);
                setResults(hits);
                setSearching(false);
            } else {
                setResults([]);
    ...
    const refreshCards = ()=>{
        ...
        if (handle) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$757418__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getDueFlashcards"])(handle).then((data)=>{
                setCards(data);
                setLoading(false);
            });
        } else {
    ...
    const handleAdd = async (e)=>{
        ...
        const handle = localStorage.getItem('cp-handle');
        if (handle) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d4ffc9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addToReviewQueue"])(handle, selectedProblem);
            clearSelection();
            refreshCards();
        }
        setAdding(false);
    ...
    const handleRate = async (quality)=>{
        ...
        setCards(remaining);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$4a45a2__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["processReview"])({
            id: current.id,
            quality
        });
...
//# sourceMappingURL=_38e2e866._.js.map