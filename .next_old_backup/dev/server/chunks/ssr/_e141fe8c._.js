...
function FlashbackPage() {
    ...
    const handleAdd = async (e)=>{
        ...
        const handle = localStorage.getItem('cp-handle');
        if (handle) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d4ffc9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addToReviewQueue"])(handle, {
                id: newId,
                name: newName
            });
            setNewId('');
...
//# sourceMappingURL=_e141fe8c._.js.map